...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: "light",
        copyright: `The Journey from Consumer to Investor: Designing a Financial AI Companion for Young Adults to Help with Sustainable Shopping, Saving, and Investing <br />Copyright © ${new Date().getFullYear()} GreenFilter.app `,
      },
      prism: {
