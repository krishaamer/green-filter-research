...
The success of interaction design depends on human psychological underpinnings. In the following tables I've used the *Theory of Planned Behavior* to categorize each feature according to what psychological state they aim to affect.
