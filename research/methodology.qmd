...
-   Interview questions
    ...
    -   Do you think the app should focus on ------ Changing legislation ------ Consumer habits ------ Investing habits ------ Smth else
...
-   should we put a price on nature (ecosystem service markets ) ? likert yes-2345-no
...
Take the metrics from the several frameworks and display them on the product and company level? People can choose their own framework and see product data through that lens and vocabularys.
...
-   If you fill out all the questions, you will participate in a lottery to win AirPods Pro 2

-   If you want to invest 5 minutes every day in sustainability, how will you do it?

-   How much time per day are you willing to spend on sustainability per day?
...
-   **What does investing mean for you? NFTs, Crypto,** Stocks, Real-estate? If you have 1000 EUR, what will you buy?
