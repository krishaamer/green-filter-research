...
partially-filled surveys. The extra ~300 partial responders barely move
the needle, with every question’s modal answer staying exactly the same,
and all the peaks and valleys shift by at most 1–2 percentage points. If
anything, the full-sample (n ≈ 1,180) show more neutrality (slightly
fewer “strong disagree” or “strong agree” ticks) and a tiny uptick in
agreeing that certified companies are better and that your spending
matters.

<div id="fig-survey-student-shopping-partial">

![](shopping_files/figure-markdown_strict/fig-survey-student-shopping-partial-output-1.png)

Figure 2: Partial: College Student Attitudes Towards Shopping

</div>

Design implications:

-   A majority of the respondents don’t plan to buy a house or car
    within 7 years: don’t focus on these categories
...
Figure 3: College Students Boycott Experience
...
Figure 4: College Students Boycott Reasons
...
Figure 5: College Student Trusted Brands
...
Figure 6: College Student Shopping Choice Experiment
