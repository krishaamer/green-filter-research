...
-   A survey of Taiwanese college students, covering attitudes towards
    shopping, saving, investing, economy, nature, sustainability, and
    AI.
...
-   Data after filtering 876 people aged 18-29 Gen-Z; Taiwanese; current
...
-   K-Means clustering was used on quantitative survey data to build
    ...
    similarity, used in large language models (LLMs), word embeddings,
    and deep learning.
