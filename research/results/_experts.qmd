...
Analysis of recorded conversation from 7 experts. Thematic content analysis using ATLAS.ti for labeling/coding the data for grounded theory. Conversations were recorded and transcribed using Google Meet, Fireflies AI, and WhatsApp. Labeling and thematic analysis was performed using Atlas.ti. Visualizations were produced using Atlas.ti and Python.
...
Table: Overview of the Interviewed Experts.
...
![Expert: Cathy Wang](./images/experts/sankey-cathy.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Expert: Cathy Wang"
  src={SankeyCathy}
/>
```
...
::: {.content-hidden unless-format="pdf"}
![Expert: Peijing Li](./images/experts/sankey-peijing.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Expert: Peijing Li"
  src={SankeyPeijing}
/>
```
...
::: {.content-hidden unless-format="pdf"}
![Expert: Jessica Cheng](./images/experts/sankey-jessica.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Expert: Jessica Cheng"
  src={SankeyJessica}
/>
```
...
::: {.content-hidden unless-format="pdf"}
![Expert: Chen-Ying Huang](./images/experts/sankey-chenying.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Expert: Chen-Ying Huang"
  src={SankeyChenying}
/>
```
...
Key learnings: "I think you are targeting experts instead of a general consumer"
...
::: {.content-hidden unless-format="pdf"}
![Expert: Yuping Chen](./images/experts/sankey-yuping.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Expert: Yuping Chen"
  src={SankeyYuping}
/>
```
...
::: {.content-hidden unless-format="pdf"}
![Experts: Shared topics in the first phase](./images/experts/sankey-all.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Experts: shared topics in the first phase"
  src={SankeyAll}
/>
```
...
::: {.content-hidden unless-format="pdf"}
![Expert: Audrey Tang](./images/experts/sankey-audrey.png){width="80%"}
:::

```{=mdx}
<Figure
  caption="Expert: Audrey Tang"
  src={SankeyAudrey}
/>
```
...
::: {.content-hidden unless-format="pdf"}
![Expert: Carlos Serra](./images/experts/sankey-carlos.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Expert: Carlos Serra"
  src={SankeyCarlos}
/>
```
## Overall Expert Feedback Summary

In the overall Sankey diagram every coded quote from the 7 expert interviewees (left column) flows into the 7 overarching themes on the right; each ribbon represents 1 excerpt, with its color matching the theme it was assigned to, and the cumulative ribbon width reveals how often that theme appeared. Purple “Design Principles” and yellow “Systems Thinking” are thickest (they dominated the discussions), while slimmer blue “AI Strategies” and peach “Simplicity” flows indicate they were discussed less; the even spread of ribbons across interviewees confirms that all participants contributed to nearly every theme, underscoring a balanced coverage and validating the qualitative coding.

::: {.content-hidden unless-format="pdf"}
![Experts: Shared Topics in the 1st and 2nd Phase](./images/experts/sankey-all-2.png){width="100%"}
:::

```{=mdx}
<Figure
  caption="Experts: Shared topics in the 1st and 2nd phase"
  src={SankeyAll2}
/>
```
The following summaries were generated by Atlas.ti for each of the 8 thematic keywords, combining insights from all the interviews, then heavily edited for brevity and formatted into tables.
