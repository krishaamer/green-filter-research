...
*Network Effects,* the more people use a platform, the more valuable it becomes. Rise of the *platform economy* has created global marketplace companies like Airbnb and Uber that match idle resources with retail demand and optimize how our cities work.

By continuously adding features (and provided consumer legislation allows it), platforms can evolve into superapps. Superapps are possible thanks to **Nudge, Economies of Scale, Network Effects, Behaviour Design.** The most successful businesses today (as measured in terms of the number of users) look at the whole user experience. Popular consumer platforms strive to design solutions that feel personalized at every touchpoint on the user journey (to use the language of service design) but doing so at the scale of hundreds of millions (or even billions) of users - personalization at scale. Superapps are honeypots of data that is used for many types of behavior modeling. For example @suarezEnhancingUserIncome2021 suggests using alternative data from super-apps to estimate user income levels, including 4 types of data: Personal Information, Consumption Patterns, Payment Information, and Financial services. Also @roaSuperappBehavioralPatterns2021 finds super-app alternative data is especially useful for credit-scoring young, low-wealth individuals. The massive amounts of data generated by these companies are used by smart cities to re-design their physical environments.
...
-   Uber is creating an all-purpopse platform; only 4.1% of rides were electric @levyUberCEOSays2023
...
-   @cuppiniWhenCitiesMeet2022 a historical overview of the development of capitalism from linear ***Fordism*** through platform economy and logistics' revolution which allows for circular economies to happen in a city.
...
-   Quantified Self is an example of Digital Healt
...
- eeg, eda, ecg: tracking features of brain, heart and nervous system activity. grace leslie: brain music sounds like a warm bathtub
