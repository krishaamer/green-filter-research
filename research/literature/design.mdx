...
-   AI labs are putting a lot of effort into engineering likable AIs ,
    Anthropic (2024a). working on honesty of the modelds, teach them to
    convey their own uncertainty Anthropic (2024b);

which sometimes can go wrong. ChatGPT o4 overnight became your biggest
fan, which users found annoying Mollick (2025)

the book, an AF (artifical friend) Klara describes loneliness Ishiguro
(2021); Waterstones (2021); Life Lessons From Books (2023)
