...
<tr class="even">
<td>JouleBug</td>
<td><pre class="text"><code> CO2 tracking</code></pre></td>
</tr>
<tr class="odd">
<td>eevie</td>
<td></td>
...
the proposal by (Commission et al., 2014) is *eco-design*, as a large
...
-   MICHAEL HOULIHAN & BONNIE HARVEY (2018) customers prefer sustainable
    companies
-   In the US, the *Inflation Reduction Act* provides funding to
    development of decarbonizing technologies and includes plans to
    combat air pollution, reduce green house gases and address
...
-   (Anon, n.d.k) report: The EU has a *taxonomy of environmentally
...
societal effects spread of misinformation.
...
(2021h) and 活動通 (n.d.) Cradle to Cradle Nordic circular design in
Taiwan
...
rather are available in-context to help streamline specific tasks. Tool
vs Assistant? Tools are mostly non-anthropomorphic.
...
the public transport system of London (Oviyam™, 2019; Anon, 2021d; Xuan,
2022).
...
*retain* users. For digital products (apps) the main application of
...
(retention and engagement), often optimizing onboarding, features, and
...
in regenerative agriculture projects (Anon, 2021c; Google, 2023).

Google VERY IMPORTANTT Google (2021). Justine Calma (Oct 6, 2021, 10:01
AM GMT+3) Google UX eco features. Anon (2021b) Google green routes.
...
Privacy and data-sharing are not in opposition. Sustainability needs to
be balanced with privacy. (Sanchez et al., 2022) suggests tracking users
using their smartphones and attributing points for actions deemed
beneficial yet this has potentially privacy issues.
...
2021e). Tracking urine consistency inside your toilet with WithThings.
...
-   “urban metabolism” (Anon, 2021i; Claire Moran, 2018), city in-out
...
consumers of fast fashion (Anon, n.d.ac). (In European Environment
...
-   Anon (n.d.q) Garment Worker’s rights
...
-   Anon (n.d.g) and Anon (n.d.o) CO<sub>2</sub> neutral factories?

-   (Anon, n.d.r; Anon, n.d.i) CO<sub>2</sub> neutral websites

-   Eric fogg (2020) Lights-Out Manufacturing

-   Mowbray (2018) “World’s first free digital map of apparel factories”

-   Anon (n.d.l) Factory compliance - Fair Factories

-   Planet Factory

-   Anon (n.d.ab) Plastic waste makers index, sources of plastic waste
...
-   There’s a growing number of companies providing re-use of existing
    items.
-   Anon (n.d.w) For example, Swap furniture in Estonia
...
doi:[10.1016/j.jpubeco.2011.03.003](https://doi.org/10.1016/j.jpubeco.2011.03.003).
...
Andrew Chaisson (2019) *How To Fight Climate Change With Great UX
Design*.
[https://medium.com/r-g-strategic/fight-climate-change-with-great-ux-design-f766c6cc6601](https://medium.com/r-g-strategic/fight-climate-change-with-great-ux-design-f766c6cc6601).
...
Anon (2021a) *A European Green Deal*.
[https://commission.europa.eu/strategy-and-policy/priorities-2019-2024/european-green-deal_en](https://commission.europa.eu/strategy-and-policy/priorities-2019-2024/european-green-deal_en).
...
Anon (n.d.e) *Charisma — Storytelling powered by artificial
intelligence*. [https://charisma.ai/](https://charisma.ai/).

Anon (n.d.f) Clean Clothes Campaign. *Clean Clothes Campaign*.
...
Anon (n.d.g) *<span class="nocase">CO2-neutral</span> factories*.
...
Anon (n.d.h) *Digital receipts and customer loyalty in one platform
ReceiptHero*.
[https://www.getreceipthero.com/](https://www.getreceipthero.com/).

Anon (n.d.i) *Ecograder*.
[https://ecograder.com/](https://ecograder.com/).

Anon (n.d.j) *Estwatch - Estwatchi värskest uuringust selgub, et Eesti
toidupoed... Facebook*.
...
Anon (n.d.k) *EU taxonomy for sustainable activities*.
...
Anon (n.d.l) FFC - Fair Factories ClearingHouse - Compliance Solutions.
...
Anon (2021b) Google mostrará por defecto la ruta más ’verde’ en su GPS y
...
Anon (n.d.m) *Grenpay - Heasta oma CO$_2$ jalajälg*.
[https://grenpay.com/et](https://grenpay.com/et).

Anon (n.d.n) *Home - ChainReact*.
[https://chainreact.org/](https://chainreact.org/).

Anon (n.d.o) *Innocent opens £200m carbon-neutral factory in Rotterdam -
Investment Monitor*.
...
Anon (2021d) Interaction Design – How to Evaluate Interaction Costs and
...
Anon (2021e) Is blood sugar monitoring without diabetes worthwhile?
*Harvard Health*.
...
Anon (n.d.p) Language Model Sketchbook, or Why I Hate Chatbots. *Maggie
Appleton*. [https://maggieappleton.com](https://maggieappleton.com).

Anon (n.d.q) *Lily mindful + active living on Instagram: ‘Yesterday, the
...
Anon (n.d.r) *Make your website carbon neutral and enhance your brand
CO2 Neutral Website*.
[https://www.co2neutralwebsite.com/](https://www.co2neutralwebsite.com/).

Anon (n.d.s) Method Podcast, Episode 18. *Google Design*.
...
Anon (n.d.t) New Standard Institute. *New Standard Institute*.
[https://www.newstandardinstitute.org](https://www.newstandardinstitute.org).

Anon (n.d.u) *Open Food Facts - World*.
[https://world.openfoodfacts.org](https://world.openfoodfacts.org).

Anon (2022e) Partnership brings sustainability mobility into superapps.
*Smart Cities World*.
[https://www.smartcitiesworld.net/news/news/partnership-brings-sustainability-mobility-into-superapps-7903](https://www.smartcitiesworld.net/news/news/partnership-brings-sustainability-mobility-into-superapps-7903).

Anon (n.d.v) *People + AI Guidebook*.
[https://pair.withgoogle.com/guidebook](https://pair.withgoogle.com/guidebook).

Anon (2022f) Protein Brands and Consumers Alike Focus on Sustainability.
*Packaging World*.
...
Anon (2022g) Reality Labs Research at Meta Connect 2022. *Tech at Meta*.
...
Anon (n.d.x) *Space Ape Games*.
[https://spaceapegames.com/green](https://spaceapegames.com/green).

Anon (n.d.y) Sulapac – Replacing plastic. *Sulapac*.
[https://www.sulapac.com/](https://www.sulapac.com/).

Anon (2022h) Support a clean energy future with Nest Renew. *Google*.
[https://blog.google/products/google-nest/nest-renew-general-availability/](https://blog.google/products/google-nest/nest-renew-general-availability/).

Anon (n.d.z) Sustainability Intelligence for Food Companies. *HowGood*.
[https://howgood.com/](https://howgood.com/).

Anon (n.d.aa) *Textile Genesis*.
[https://textilegenesis.com/](https://textilegenesis.com/).

Anon (2021g) The company now dominating European fintech is… Paypal.
*Sifted*.
[https://sifted.eu/articles/paypal-tops-european-downloads/](https://sifted.eu/articles/paypal-tops-european-downloads/).

Anon (n.d.ab) *To the companies we have unveiled in the Plastic Waste
Makers Index:*
...
Anon (2022i) Will Europe get a superapp, and who will it be? *Sifted*.
[https://sifted.eu/articles/europe-superapp-revolut-klarna/](https://sifted.eu/articles/europe-superapp-revolut-klarna/).

Anon (n.d.ac) Young Consumers’ (Complicated) Love For Fast Fashion In 3
Stats. *YPulse*.
...
Anon (2021h) 台灣設計研究院（TDRI ） on Instagram: "▌北歐循環設計論壇
開放報名中 -
...
application to diet management. *Journal of Biomedical Informatics*. 68,
58–70.
doi:[10.1016/j.jbi.2017.02.015](https://doi.org/10.1016/j.jbi.2017.02.015).
...
*Architechtures*.
[https://architechtures.com/en/what-is-artificial-intelligence-and-how-do-you-work-with-it/](https://architechtures.com/en/what-is-artificial-intelligence-and-how-do-you-work-with-it/).
...
*Public Health*. 175, 8–18.
doi:[10.1016/j.puhe.2019.06.011](https://doi.org/10.1016/j.puhe.2019.06.011).
...
Ayoola, I., Wetzels, M., Peters, P., Van Berlo, S. & Feijs, L. (2018) Do
CHANGE platform: A service-based architecture for secure aggregation and
distribution of health and wellbeing data. *International Journal of
Medical Informatics*. 117, 103–111.
doi:[10.1016/j.ijmedinf.2018.06.004](https://doi.org/10.1016/j.ijmedinf.2018.06.004).
...
pro-environmental action in climate change deniers. *Nature Climate
Change*. 2 (8), 603–603.
doi:[10.1038/nclimate1636](https://doi.org/10.1038/nclimate1636).
...
Berger, M., Lange, T. & Stahl, B. (2022) A digital push with real impact
– Mapping effective digital nudging elements to contexts to promote
environmentally sustainable behavior. *Journal of Cleaner Production*.
380, 134716.
doi:[10.1016/j.jclepro.2022.134716](https://doi.org/10.1016/j.jclepro.2022.134716).
...
wearable technologies? *Computers & Education*. 88, 343–353.
doi:[10.1016/j.compedu.2015.07.013](https://doi.org/10.1016/j.compedu.2015.07.013).
...
Brantley, A.P. (2021) *Brewing a boycott: How a grassroots coalition
fought Coors and remade American consumer activism*. Justice, power, and
politics. Chapel Hill, The University of North Carolina Press.
...
operational research with hybrid practice theories. *European Journal of
Operational Research*. 277 (3), 1137–1150.
doi:[10.1016/j.ejor.2019.03.027](https://doi.org/10.1016/j.ejor.2019.03.027).
...
[https://umg.mit.edu/blog/read/what-is-urban-metabolism](https://umg.mit.edu/blog/read/what-is-urban-metabolism).
...
Dzigajev, M. (2019) *How can we influence human behaviour using UX to
accommodate improvement for climate change?*
doi:[10.13140/RG.2.2.29820.80007](https://doi.org/10.13140/RG.2.2.29820.80007).

EarthCheck (2023) EarthCheck - Good For Business, Good For The Planet.
*EarthCheck*. [https://earthcheck.org/](https://earthcheck.org/).
...
Fletcher, O. (2022) ‘Friendly’ and ‘noisy surveillance’ through MapMyRun
during the COVID-19 pandemic. *Geoforum*. 133, 11–19.
doi:[10.1016/j.geoforum.2022.05.004](https://doi.org/10.1016/j.geoforum.2022.05.004).
...
doi:[10.1016/j.sheji.2017.08.001](https://doi.org/10.1016/j.sheji.2017.08.001).
...
*Maturitas*. 113, 40–47.
doi:[10.1016/j.maturitas.2018.04.012](https://doi.org/10.1016/j.maturitas.2018.04.012).
...
Greenbaum, D. & Gerstein, M. (2016) Who Owns Your DNA? *Cell*. 165 (2),
257–258.
doi:[10.1016/j.cell.2016.03.032](https://doi.org/10.1016/j.cell.2016.03.032).
...
becomes disruptive: Evidence from China’s ‘super app’ WeChat. *Mobile
Media & Communication*. 9 (2), 177–194.
doi:[10.1177/2050157920940765](https://doi.org/10.1177/2050157920940765).
...
L. Hyman & J. Tohill (eds.) (2017) *Shopping for change: Consumer
...
Iman Ghosh (2020) *Mapped: Where Are the World’s Most Sustainable
Companies?*
[https://www.visualcapitalist.com/most-sustainable-companies/](https://www.visualcapitalist.com/most-sustainable-companies/).
...
*L’Autre Couleur*.
[https://lautrecouleur.com/notable-sustainable-companies-in-florida/](https://lautrecouleur.com/notable-sustainable-companies-in-florida/).
...
[https://www.gartner.com/en/articles/what-is-a-superapp](https://www.gartner.com/en/articles/what-is-a-superapp).
...
Lose, A. (2023b) Using My Skills as a UX Writer to Tackle Climate Change
and Promote Biodiversity. *Medium*.
[https://medium.com/@ashleylosewriter/using-my-skills-as-a-ux-writer-to-tackle-climate-change-and-promote-biodiversity-253c9007bb45](https://medium.com/@ashleylosewriter/using-my-skills-as-a-ux-writer-to-tackle-climate-change-and-promote-biodiversity-253c9007bb45).
...
sustainability and interaction. In: *CHI ’07 Extended Abstracts on Human
Factors in Computing Systems*. April 2007 San Jose CA USA, ACM. pp.
2121–2124.
doi:[10.1145/1240866.1240963](https://doi.org/10.1145/1240866.1240963).
...
MICHAEL HOULIHAN & BONNIE HARVEY (2018) *It’s Official: Customers Prefer
Sustainable Companies Entrepreneur*.
[https://www.entrepreneur.com/growing-a-business/its-official-customers-prefer-sustainable-companies/324001](https://www.entrepreneur.com/growing-a-business/its-official-customers-prefer-sustainable-companies/324001).
...
program be augmented by wearable sensor technology? *Internet
Interventions*. 2 (3), 330–339.
doi:[10.1016/j.invent.2015.04.005](https://doi.org/10.1016/j.invent.2015.04.005).
...
after the implementation of a congestion tax. *Journal of Environmental
Psychology*. 46, 1–9.
doi:[10.1016/j.jenvp.2016.01.011](https://doi.org/10.1016/j.jenvp.2016.01.011).
...
Playing for the Planet Alliance (2021) *Playing for the Planet Annual
Impact Report*.
...
environmental and human health. *Environmental Modelling & Software*.
74, 238–246.
doi:[10.1016/j.envsoft.2015.06.003](https://doi.org/10.1016/j.envsoft.2015.06.003).
...
Policies. In: L. Steg & J.I.M. De Groot (eds.). *Environmental
Psychology*. Chichester, UK, John Wiley & Sons, Ltd. pp. 295–306.
doi:[10.1002/9781119241072.ch29](https://doi.org/10.1002/9781119241072.ch29).

September 16, 2020 (2020) *What is <span class="nocase">AI-assisted
Design</span>? Renumics GmbH*.
[https://renumics.com/blog/what-is-ai-assisted-design/](https://renumics.com/blog/what-is-ai-assisted-design/).
...
W. Shi, M.F. Goodchild, M. Batty, M. Kwan, & A. Zhang (eds.) (2021i)
*Urban informatics*. The urban book series. Singapore, Springer.
...
Switch2Green (2023) *The EU Green Deal – a roadmap to sustainable
economies*.
[https://www.switchtogreen.eu/the-eu-green-deal-promoting-a-green-notable-circular-economy/](https://www.switchtogreen.eu/the-eu-green-deal-promoting-a-green-notable-circular-economy/).
...
Thomas, L., Briggs, P., Kerrigan, F. & Hart, A. (2018) Exploring digital
remediation in support of personal reflection. *International Journal of
Human-Computer Studies*. 110, 53–62.
doi:[10.1016/j.ijhcs.2017.10.002](https://doi.org/10.1016/j.ijhcs.2017.10.002).
...
*Environment International*. 104, 155–162.
doi:[10.1016/j.envint.2017.04.003](https://doi.org/10.1016/j.envint.2017.04.003).

Tsai, J.-M., Hsu, C.-Y., Tsai, L.-Y. & Tsay, S.-L. (2019) Translation
and validation of Taiwan Chinese version of the self-regulation
questionnaire for gynecologic cancer survivors. *Taiwanese Journal of
Obstetrics and Gynecology*. 58 (5), 614–620.
doi:[10.1016/j.tjog.2019.05.032](https://doi.org/10.1016/j.tjog.2019.05.032).
...
[https://uia2023cph.org/design-for-climate-adaptation/](https://uia2023cph.org/design-for-climate-adaptation/).

Undheim, T.A. (2024) *Eco tech: Investing in regenerative futures*.
...
United Nations Conference on Trade and Development (last) (2023) *World
Investment Report 2023*. World Investment Report.
...
Wirani, Y., Nabarian, T. & Romadhon, M.S. (2022) Evaluation of continued
use on Kahoot! As a gamification-based learning platform from the
perspective of Indonesia students. *Procedia Computer Science*. 197,
545–556.
doi:[10.1016/j.procs.2021.12.172](https://doi.org/10.1016/j.procs.2021.12.172).
...
Zakariya, C. (2022) Stop Using Jasper Art: Use the New Canva AI Image
Generator \[Video\]. *ILLUMINATION*.
[https://medium.com/illumination/stop-using-jasper-art-use-the-new-canva-ai-image-generator-video-f91a33ed9c15](https://medium.com/illumination/stop-using-jasper-art-use-the-new-canva-ai-image-generator-video-f91a33ed9c15).

Zeng, M. (2015) Three paradoxes of building platforms. *Communications
of the ACM*. 58 (2), 27–29.
doi:[10.1145/2700343](https://doi.org/10.1145/2700343).
