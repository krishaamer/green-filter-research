...
## Student Protests Around the World and The Attitude-Behavior Gap
...
![](college_files/figure-markdown_strict/cell-3-output-1.png)
...
(Ministry of Education of Taiwan, 2024a).

xuDeclinedQualityPoststructural2024
...
Taiwan has an aging population (Goh et al., 2023). Taiwanese culture is
...
more active role and gain ownership of their education (Chang, Wegerif &
Hennessy, 2023). In general, teachers have a positive attitude towards
sustainability. Taiwanese government launched the Sustainable Council in
1997 to promote of environmental and sustainable development; a survey
of university-level teachers (n=100) in central Taiwan (Taichung,
...
I found less research on the university level. (Chen & Tsai, 2016)
reports a *positive attitude yet moderate knowledge* about *ocean
sustainability* among Taiwanese college students (n=825). (Liu et al.,
2023) studied sustainability behavior of Taiwanese University students,
reporting the COVID-19 pandemic, in addition to prevalence of health
issues, also spurred more attention on environmental topics. In a
...
sustainability education (姚 & 侯, 2011).
...
## Climate Change Effect on Taiwan
...
## Taiwanese Companies and Online Shopping
...
University campuses are somewhat healthier than other areas.

There are several decades of research on pollution levels in Taiwan,
most with very scary correlations to health.
...
religion plays a role in pollution:
...
-   Taiwan is a growing market for luxury brands (Karatzas, Kapoulas &
    Priporas, 2019).
