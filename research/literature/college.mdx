...
A large-scale global study by (Anthony Leiserowitz et al., 2022) on
Meta’s Facebook (n=108946) reported people in Spain (65%), Sweden (61%),
and Taiwan (60%) believe *“climate change is mostly caused by human
...
``` text
<function charts.college.taiwanese_company_ranking_chart()>
```
