...
### Taiwanese Youth's Financial Literacy and Education
...
### Democratization of Finance: Fintech as a Precursor for Sustainable Superapps
...
#### Legislative Efforts Empowering Consumers to Deploy Capital in Sustainability
...
#### Lack of ESG Standardization: An Opportunity to Solve Opaque Metrics
...
### Towards Green Transparency - Who Does the Rating
...
The CEO of the Swedish clothing producer H&M - one of the largest fast-fashion companies in the world -, recognized the potential impact of *conscious consumers* as a threat [@hoikkalaHMCEOSees2019] and at the same time launched a clothes repair service in partnership with the Norwegian start-up Repairable, as reported by the Norwegian Sustainability Hub [@shubHMInvestsSustainable2018]. This kind of discrepancies are all over the place. While Coca-Cola is the largest plastic polluter in the world, at the same time it runs the “World Without Waste” program which supports packaging recycling around the world, reporting achieving a global 90% recycling rate for Coca-Cola packaging [@simoes-coelhoBalancingGlobalCorporate2023; @breakfreefromplastic2023GlobalBrand2024]. Large corporations such as Coca-Cola and Nestle also support the biodiversity law, calling for a level playing field for business limit biodiversity risk [@greensefaNatureVoteSuccess2023].
...
#### Curbing Corruption with Real-time Data Streams and Product Lifecycle Traceability
...
### One Wallet to Rule Them All: Shopping, Saving, and Investing - The Evolution of Payments
...
### Payments as the Entry Point for Financial Services

#### The Entry Point for Personal Finance from Mobile Wallets to Buy Now Pay Later (BNPL) Services - Globally, and In Taiwan
...
#### Hidden Costs and Pricing Externalities

Markets mis-price economics, originally meaning “home maintenance.”

Co-founder of Generation Capital with 50 Billion under management (David Blood) believes *"the most significant thing we can do as capital allocators is to price in those difficult to price externalities"* [@liebreichAreBigInvestors2025]
...
In a similar vein, [@konradA16zCryptoLeads] imagines the possibility of an internet-wide directory of purchasable products, akin to how platforms like Spotify have made nearly all the world's music easily searchable and accessible. However, despite the obvious need, attempts to build such directories have faced significant challenges. For example, the Open Knowledge Foundation's Open Product Data initiative [@OpenProductData] was eventually shut down, highlighting how difficult it is to maintain open, comprehensive, and up-to-date product information at a global scale.
