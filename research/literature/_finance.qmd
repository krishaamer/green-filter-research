...
### Spurred by Fintech: The Democratization of Finance as a Precursor to Sustainable Superapps
...
Since the 1970s, international bodies, governments, and private corporations have developed sustainability measurement metrics, the prominent one being ESG (Environmental, Social, and Corporate Governance) developed by the UN in 2005. The ESG criteria has already been implemented or is in the process of being adopted on stock markets all over the world and has implications beyond the stock markets, allowing analysts to measure companies' performance on the triple bottom line: the financial, social, and environmental metrics holding the potential for countering misinformation with transparency.
...
ESG ratings give banks a new tool to market and sell environmentally conscious opportunities to institutional investors, for example, universities. A case in point being the recent partnership between HSBC and the University of Edinburgh [@reidUniversityEdinburghGoes2020]. Another example is one of the largest private banks in Switzerland, Lombard Odier & Co, when they launched a thematic bio-economy fund inspired by the words of The Prince of Wales, 'Building a sustainable future is, in fact, the growth story of our time' [@jerseyeveningpostCharlesAchievingSustainable2020].

[@ImportanceESGMeasurement2022] suggests ACWI ESG leaders outperform the non-ESG screened ACWI based on comparing MSCI indexes. It's notable that ACWI ESG began to outperform the traditional ACWI only in the past few years.
...
### Modern Slavery Persists and Worsens Sustainability: ESG Falls Short in Protecting Workers' Rights and Mitigating Environmental Harm
...
#### Consumer Activits are Only a Small Minority
...
#### Shopping's Environmental Footprint is Driven by Digital Platforms, Social Commerce, and AI Assistants
...
#### The Evolution of Payments from Mobile Wallets to Buy Now Pay Later Globally and In Taiwan
...
### Inaccesible for Retail Investors: Futures, Hedge Funds, Private Equity, and Venture Capital
...
### Investable Asset Classes and Platforms: Retail Investors' Increasing Exposure to Stocks, Bonds, Commodities, Real-Estate, Digital Tokens, Lending, and Alternatives
...
### Fusion of Traditional and Decentralized Finance (DeFi): The Rise of Stablecoins
...
In 2024-25, stablecoins emerged as the prominent technology to link traditional and decentralized finance, bridging different forms of money between systems, enabling seamless integration. This is a key design feature, as the users likely won’t care about “crypto” vs “bank” as it's all just *digital money*.
...
### Divestment as a Form of Supporting Sustainability
...
The possibility of decoupling economic growth from CO~2~e emissions (also known as decarbonizing the economy or eco-economic decoupling) or is hotly debated among scientists. [@keysserDegrowthScenariosSuggest2021] provides several scenarios for low, medium, and high levels of decoupling titled Degrowth, IPCC, and Dec-Extreme.
...
## Efforts to Curb Greenwashing: From Data-Driven Benchmarks to Fighting for Transparency
