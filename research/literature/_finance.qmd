...
In theory, Socially Responsible Investing (SRI) integrates ESG criteria to screen out harmful industries and direct capital to companies with positive social and environmental impacts for both ethical and financial returns [@SociallyResponsibleInvesting]. Nonetheless, a large-scale input–output life-cycle assessment of 1340 European equity funds (11275 unique holdings) including sustainable (SRI) funds, and found that 24% of the sampled SRI funds actually show higher total CO2 emissions exposure within their assets than a conventional market index [@popescuAreSRIFunds2023]. ESG companies don't emit less CO2 than non-ESG companies.. ESG Criticism "25 ESG ratings from three major providers (Moody's Analytics, MSCI Inc., and Refinitiv)" - *"well-rated companies do not emit significantly less carbon than those with lower scores."* [@amencGreenDilutionHow2023]. [@agnewRIPESG2022] Argues that ESG has become a diluted corporate marketing label nearing the end of its usefulness, and urges a pivot toward more substantive responsible-investment practices beyond checkbox ESG.
...
A systematic study of 153 peer-reviewed papers of ESG literature published between 2006 and 2023 around the world reports the major determinants of high ESG performance are board member diversity, firm size, and CEO attributes; actively diversifyng boards, especially adding members with sustainability expertise, and aligning executive compensation with ESG targets to translate strategic ambitions into operational results, may boost ESG outcomes [@martinyDeterminantsEnvironmentalSocial2024].

```{python}
ck_board_diversity()
```

The CEO of the Swedish clothing producer H&M - one of the largest fast-fashion companies in the world -, recognized the potential impact of *conscious consumers* as a threat [@hoikkalaHMCEOSees2019] and at the same time launched a clothes repair service in partnership with the Norwegian start-up Repairable, as reported by the Norwedgian Sustainability Hub [@shubHMInvestsSustainable2018]. These kind of discrepancies are all over the place. While Coca-Cola is the largest plastic polluter in the world, at the same time it runs the “World Without Waste” programme which supports packaging recycling around the world, reporting achieving a global 90% recycling rate for Coca-Cola packaging [@simoes-coelhoBalancingGlobalCorporate2023; @breakfreefromplastic2023GlobalBrand2024]. Large corporations such as Coca Cola and Nestle also support the biodiversity law, calling for a level playing field for business limit biodiversity risk [@greensefaNatureVoteSuccess2023].
...
: GenAI usage for comprehensive risk management from in banking as per [@rahulagarwalHowGenerativeAI2024].
...
Crypto-assets and digital tokens (known as DeFi or decentralized finance) are a highly accessible yet risky asset class, offering investment opportunities to anyone with a mobile phone and internet access. The low entry barrier makes crypto among the most potentially inclusive forms of investment, though bearing significant risks, as well as regulatory challenges in some countries. Crypto investing removes most entry barriers while having high risk. Cryptocurrencies are the most popular financial action among young people yet in some ways crypto needs even more financial literacy than traditional financial assets. [@statistaCryptocurrenciesWorldwideStatista2024] estimates over 860 million cryptocurrency users worldwide by 2025. A Brazilian study (N=573) found "Crypto investors in Brazil are generally younger, male, and exhibit higher risk tolerance compared to non-crypto investors." @colomboAreCryptoNoncrypto2024 "Brazil's planned adoption of CBDC (Central Bank Digital Currency)." "It finds that risk tolerance, economic pessimism, and a belief in better investment acumen are significant predictors of crypto investment."

Taiwan has an active market for crypto-assets while with some limitations. In 2022, the Taiwan government banned buying cryptocurrencies with credit card quoting the volatility makes it similar to gambling [@davidattleeBuyingCryptoCredit2022; @MiHuoBi2022].

Crypto enables significant potential for financial engineering and innovation by anyone with some programming skills.
...
There's also a large trend of fusion of decentralized finance (DeFi) and traditional finance (TradFi), with the largest established investors, such as BlackRock, launching tokenized funds [@sandorTokenizedTreasuryFunds2024; @matosAaveLabsUnveils2024; @securitizeBlackRockLaunchesIts2024]. The First crypto fund was launched already in September 2021, FINMA approved Switzerland’s first regulated crypto-asset fund—the Crypto Market Index Fund—giving qualified investors access to a FINMA-supervised vehicle that tracks a diversified basket of blockchain-based assets with SEBA Bank custody [@finmaApprovalFirstSwiss2021].
...
-   @openseaTopTaiwanInfluencers2022 Taiwanese digital influencers as NFTs. In January 2022, BlockTempo and OpenSea teamed up to mint the “Top Taiwan Influencers” collection—21 unique, limited-edition NFTs depicting Taiwan’s leading blockchain figures, designed to honor their industry contributions in digital art
...
While Bitcoin uses proof-of-work, and protocol which is highly energy intensive (and thus, unsustainable), later innovations such as proof-of-stake enabled the creation of blockchains, which are energy-efficient; an overview details 23 low-carbon blockchains [@alzoubiGreenBlockchainMove2023]. @dgen&positiveblockchainBlockchainSDGsHow2021 built a positive Blockchain Database of blockchain for good projects.
