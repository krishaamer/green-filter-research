```{python}
#| echo: false
#from literature.charts.money import money_chart
from charts.finance import money_chart, fintech_chart, asset_classes, shopping_growth, world_bank_bonds, growth_brics, esg_fintech_chart, esg_fintech_heatmap, social_commerce_chart, conventional_vs_sri_funds
import warnings
...
*Fintech* - financial technologies - linked to *ESG* (Environmental, Social, and Corporate Governance) may hold the potential to drive consumers on a pathway towards sustainable investing. Does this funnel work - and it's indeed a complex multi–step funnel -, depends on whether we can deliver a simple user experience and curb greenwashing to a level that allows consumer to distinguish eco–friendly businesses from the heavy polluters.

This chapter explores the larger trend of *Democratization of Financial Markets* through consumer-facing apps that enable new interactions which increasingly blur boundaries between shopping, saving, and investing. Efforts to boost user numbers have made apps that started out with payments-only - such as Revolut and N26 - branch out into offering savings accounts and investing options. Regardless of if it's money spent on shopping or saved and invested, these are all decision of capital allocation, and in one way or another, we're giving our money to companies. The critical question is: do we choose to support sustainability-focused companies or those that pay less attention to sustainability?

Users are beginning to become money-savvy yet are still missing many key ideas from financial literacy. Giving users exposure to investment opportunities through familiar activities that may have the potential to boost financial literacy levels and entice consumers to learn more about taking advantage of their opportunities financial markets - as well as how to manage the types or risk involved.
...
Money is becoming more diverse and the meaning of money itself is changing. We have the fiat money created by governments by law, using central banks, which loan money to commercial banks. And we also have new types of money is also created by companies and individuals using cryptography on blockchain-based distributed databases, which keep track of transactions (who-paid-whom). Whatever the method of creation, in essence, money is a *system of trust* where *something* is used as a *medium of value exchange* and accepted by *other people* as payment. Digital money in it's various forms connects industries on the same apps, which make investing more accessible and socially engaging, appealing to younger people who are active in social media and online shopping. Added to that the trend of sustainably, how can sustainability become more accessible? People want to shop, save, and invest sustainably - how to do it?
...
Legislation is Catching Up With Fintechs
...
-   Legislation sets higher standards.

-   @WorldEconomicOutlook2023

### Shopping

Banks and Fintechs Capture User Data. Payments are an Entry Point and Source of Consumer Action Data, Shopping Data. Payments is the primary way consumers use money. Is there a funnel From Payments to Investing?
...
![Bunq promises to combine banking and eco-friendly actions in the same user interface - yet is this greenwashing?](./images/bunq.jpg){width="100%"}
:::
...
Buy Now Pay Later (BNPL) is the biggest consumer payments / financing success story innovated by Klarna in Sweden in 2005 and Afterpay in Australia in 2015 but with roots in Layaway Programs created during the 1930's US Great Depression \[kentonWhatLayawayPlan2023\].

-   Gen-Z mostly used BNPL to buy clothes.
-   44.1% of Gen-Z in the US had used BNPL in 2022 [@emarketerAlmost75BNPL2021].
-   ***Design Implication:*** This suggests users are already used to having more options in the payment flow.
-   However @theinfluencerfactoryStatusSocialCommerce2021 suggest Chinese and U.S. markets may be mature and growth will come from emerging markets (SEA, Latin-America); China is the furthest ahead in social shopping.

https://www.emarketer.com/content/almost-75-of-bnpl-users-us-gen-z-millennials https://www.lhv.ee/en/blog/buy-now-pay-later-option-more-popular-than-ever-before
...
-   Sustainable Consumerism via Self-Regulation. 2M EUR project for the shopping app. [@gklinglmayrSustainableConsumerismSelfRegulation2016]
...
*Double Eleven* celebrated on November 11th (11/11) is the world's largest shopping festival [@double11festival2023]. In June 2023, 526 million people watch e-commerce live-streams in China; online bargaining is a type of ritual [@liuBargainingChineseLivestream2024].
...
Projected growth in online shopping [@forresterForresterGlobalOnline2024]
...
-   What is the consumer CO~2~ contribution? What is the target?
...
-   Robinhood uses game-like features such as displaying a confetti animation to create a sense of excitement around trading investing.

-   Encourage impulsive short-term buying and selling with a focus on speculation over fundamentals.

-   Cause FOMO (fear of missing out)

#### Plap

-   In housing development, there's evidence of 'green' buildings achieving a 'higher financial return than conventional buildings, both in terms of rent and sale price' [@oyedokunGreenPremiumDriver2017].

-   There's also a trend of investors looking for sustainability in addition to profits in a few countries.
...
Divesting is the inverse of investing.
...
-   <https://www.sciencedirect.com/science/article/pii/S2212567115011223>

-   <https://www.sciencedirect.com/science/article/pii/S1877343523001410>

-   

#### Growing Choice of Asset Classes
...
-   Newer literature notes robo-advisor related research is scattered across disciplines [@zhuImplementingArtificialIntelligence2024]. -- Athropomorphism: human-like attributes in robo-advisors, such as conversational chatbots, can affect adoption and risk preferences among customers. Studies show that anthropomorphized robo-advisors increase customer trust and reduce algorithm aversion." **similar to my research**
...
::: {.content-hidden unless-format="pdf"}
![Out-of-date user interface of a European AI-Advisor ETFmatic in 2017 which was closed down in 2023 (Photo copyright ETFmatic)](./images/etfmatic.png){width="100%"}
:::
...
-   @swissinfo.ch/ursSwissCryptoValley2022 "More than half of the Swiss banks plan to offer digital assets services over the next few years."
...
-   Increasingly available to co-invest on investing platforms.
...
-   Centralized Crypto Exchanges are in essence loaning assets from the user. "The piece of the settlement aimed at getting important information to customers is more understandable from a retail protection standpoint. Customers who lend crypto assets to a company in exchange for a promised return should get the information they need to assess the risks against the rewards" [@hesterm.peirceSECGovStatement2022].
...
-   @raidotonissonSedaAktsionaridOstaksid2022 due to a law change Estonian could take out their pensions and invest or spend them however they wanted. @raidotonissonLHVToiKlientideni2022 Estonian bank selling Metaverse cryptocurrency Sandbox
...
Bad news. How Much Money Is Needed? It would be easier for large institutional investors to move their money to sustainable assets than for retail investors to move their relatively small investments.

Sustainability lacks Trillions of USD in investment - even with massive financing going into sustainability, there's still a lack of investing. The estimate for the global *financing gap* for low-carbon energy production was 5.2 Trillion USD as of 2016 [@MappingGapRoad2016; @earthdayEarthDay20232023]. A newer United Nations Environmental Programme (UNEP) calculation lowered the world needs an additional **4.1 Trillion USD** of financing in nature-based solutions by 2050 to meet climate change, biodiversity, and land degradation reduction targets [@unepUNEPGreenFinance2022]. According to [@therockefellerfoundationWhatGetsMeasured2022] a slightly lower **2.5-3.2 Trillion USD** would be sufficient.
...
What if 10% of annual consumer spending – *ten percent is about \$2,8T* - went towards protecting our climate?
...
-   Ray Dalio puts the needed climate investment at \$5T yet believes these financial goals won't be met @raydalioFourthBigForce2023
...
The possibility of decoupling economic growth from CO2 emissions (sometimes called eco-economic decoupling or decarbonizing economies) or even decoupling from environmental degradation - is a topic debated among scientists.

-   [@keysserDegrowthScenariosSuggest2021] provides several scenarios for low, medium, and high levels of decoupling.

<!-- -->

-   In the United Kingdom, [@harrissonAnalysisWhyUK2019] concludes UK's CO2e emissions have fallen 43% from 1990 to 2017 through the use of less carbon-intensive energy sources and argues for moderate policies in [@hausfatherEmissionsBusinessUsual2020]. Meanwhile, contrarily, [@globalcarbonbudgetCumulativeCOEmissions2023]'s data shows an increasing CO2e emissions trend in the UK in the same timeframe.

```{python}
growth_brics()
```

CO2 emissions and GDP growth per capita follow a similar path in the BRICS countries (Brazil, Russia, India, China, South Africa) as well as Vietnam and Somalia [@vianaespinosadeoliveiraRenewableNonrenewableEnergy2022; @warsameNaturalDisastersDeforestation2024; @raihanSustainabilityVietnamExamining2024].
...
*Econometrics* is the science and art of measuring the economy. The creator of the Gross Domestic Product (GDP) metric in 1934 Simon Kuznets said: "The welfare of a nation can scarcely be inferred from a measurement of national income as defined by GDP...Goals for 'more' growth should specify of what and for what" [@unitedstates.bureauofforeignanddomesticcommerceNationalIncome192919321934]. GDP was the culmination of previous work by many authors, beginning with William Petty in the 17th century @rockoffGoodStartNBER2020. This long journey underlines how a metric about a complex system such as the economy is continuous work in progress. There has been ongoing work to create improved metrics such as the the Sustainable Development Goals (SDGs), Human Development Index (HDI), Genuine Progress Indicator (GPI), Green GDP, Inclusive Wealth Index, and others [@bleysBarriersOpportunitiesAlternative2015; @kovacicGDPIndicatorsNeed2015; @anielskiMeasuringSustainabilityNations2001]. Measuring wellbeing in addition to GDP and the metric should including resiliency dashboards, to to visualize metrics beyond GDP and they are an integral part of country reports [@greensefaBeyondGrowthChangingGoal2023]. Similarly, the doughnut (donut) economics (more below) model calls for a "dashboard of indicators" [@tedHealthyEconomyShould2018].

*Ecological Economics* is the prime suspect for eco-conscious ideas to incorporate into design, drawing attention to the interdependence of economy and the ecosystem; there are physical limits to economic growth on a planet with finite resources. The founder of the field Herman Daly was talking about *prosperity without growth* more than two decades ago, focusing on the diminishing natural resources [@dalyGrowthEconomicsSustainable1997]. [@jacksonProsperityGrowthEconomics2009; @jacksonProsperityGrowthFoundations2017] expanded on these ideas with recipes for a post-growth world, making the ideas seem more tangible and precise.
...
Several EU cities have adopted the vision [@teicherDoughnutEconomicsHas2021]. Doughnut in Brussels, Belgium. Everything has to be adapted to the place and context [@oikosdenktankWebinarDoughnutEconomics2021; @brusselsdonutHomeBrusselsDonut2022]. The city of Amsterdam is developing shorter food chains (which save CO~2~) and linking residents with food production and reconnecting people to the food. Food become a sort of ***social object***, which foster collaboration in the community [@circleeconomyKeynoteIlektraKouloumpi2021]. Amsterdam also has a Circular Economy Monitor which makes it easy for anyone to see the progress being made towards the Dutch goal to be a circular economy by 2050 [@waterstaatCircularDutchEconomy2019; @gemeenteamsterdamCircularEconomyMonitor2022].
...
Prices Do Not Capture All Costs "CONSUMPTION, PRODUCTION, AND INVESTMENT decisions of individuals, households, and firms often affect people not directly involved in the transactions." @helblingExternalitiesPricesNot
...
-   Conceived by Alfred Marshall and Arthur Cecil Pigou
...
-   Whie Adam Smith is most famous for his concept of the invisible hand, his writings also highlight the interdependence of economic actors [@atalAdamSmithHis2024]

## Defeating Greenwashing with Data-Driven Benchmarks
...
-   Greenwashing is a large detractor from environmental action as it's difficult to know what is sustainable and what is not. Greenwashing Disturbs Sustainable Capital Allocation. Greenwashing erodes trust. Greenwashing has a negative Impact on Credibility.
...
-   Determinants of high esg performance are board member diversity, firm size, ceo attributes @martinyDeterminantsEnvironmentalSocial2024.

Design: show the board members in the app product view.

### Indices

-   [@yukselConstructingIndexParticipation2023] criticizes excessive financialization for the 2008 economic crisis where the real economy and financial markets disconnected, proposing a new index for *participation finance* aiming to ground the financial economy in the real economy; rooted in Islamic banking, participation finance avoids highly speculative activities, which are seen as exploitative, looking to promote stability, transparency, and fairness.

Companies assess customer's credit score to decide credit-worthiness, however how can customers rate companies? Indexes make comparing companies possible. There are many-many Indexes, Scoring Systems, Ratings, Certifications, etc.
...
-   The Conservation Alliance: [@climateneutralcertifiedClimateNeutralStandards2023].

-   1% For the Planet

-   For example **Flickr invested 3000 USD in carbon credits.**

-   Rating Systems:

-   ESG Shopping: "Changing our relationship with money"

-   Nordic Climate Transparency Leadership: "companies with higher quality climate reporting also provide higher returns"

### Certification

Research shows certification does matter. Consumers are willing to pay more for bio-based products "72% of Europeans are willing to pay more for environmentally friendly products. The study identifies a "green premium" and a "certified green premium," indicating increased WTP for bio-based and certified bio-based products." @moroneConsumerWillingnessPay2021 (need access).

-   In Italy, consumer awareness of sustainable supply chains, Italian consumers have a strong preference for antibiotic-free meat [@mazzocchiConsumerAwarenessSustainable2022].
...
-   Science-Based Targets initiative (SBTi) provides step-by–step guidance per economic sector help companies get started with meeting climate criteria and emission reduction requirements.
...
-   Greenly Decarborization Index @greenlyGreenlyIntroducesClimate2023
...
-   ESG Criticism "25 ESG ratings from three major providers (Moody's Analytics, MSCI Inc., and Refinitiv)" - "well-rated companies do not emit significantly less carbon than those with lower scores." @amencGreenDilutionHow2023
...
-   openesg.com/because you can't trust ESG [@aikmanESGDAOOut2022] !
...
### ESG Data Streams for Realtime Reporting
...
+----------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                | -   Given the large number of fraud cases in finance, *trust* is the number one concern for users (ADD CITATION). Good design is crucial for creating transparency, and transparency leads to trust.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
+----------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
