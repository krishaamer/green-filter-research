...
-   While promising to become sustainable, oil companies are increasing production; Sunak, the UK Primise Minister announced 100 new licenses for oil drilling in the UK [@noorBigOilQuietly2023].
...
There's also a large trend of fusion of decentralized finance (DeFi) and traditional finance (TradFi), with the largest established investors, such as BlackRock, launching tokenized funds [@sandorTokenizedTreasuryFunds2024; @matosAaveLabsUnveils2024; @securitizeBlackRockLaunchesIts2024].
...
With a specific sustainability focus, [@TreesFuture2023] DAOs to enable concerted action towards climate goals using the pooled resources in a treasury, a blockchain (on-chain), similar to how hedge funds work.
