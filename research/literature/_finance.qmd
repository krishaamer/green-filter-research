...
Sustainable capital allocation methods are many. Regardless of if it's money spent on shopping or money saved and invested, these are all financial decisions of *capital allocation*, and in one way or another, we're giving our money to companies pushing economic growth.

The critical question is: do people choose to support sustainability-focused companies - companies which invest deeply into green innovation and eco-friendly practices - or those that pay less attention to sustainability?
...
Campain to ban polluting products campaign success story, EU shops can't sell deforestation products gathered over 100 thousand online signatures [@EUBanForestkilling2022]. Legislation banning products contributing to deforestation was passed by the EU Parliament and Council in 2023 and came into effect in July 2024 [@europeanparliamentRegulationEU20232023; @abnettUnitedStatesAsks2024]
...
Double Eleven 11/11 celebrated on November 11th is the world's largest shopping festival [@double11festival2023]. In June 2023, 526 million people watch e-commerce live-streams in China; online bargaining is a type of ritual [@liuBargainingChineseLivestream2024].
...
-   @iginiEnvironmentalImpactOnline2022 Online Shopping impact. Single's day, etc.
...
An Australian fintech Douugh released it's robo-advisor in 2024 @paulDouughFintechBudgeting2024

Douugh's tagline explain the ethos of a unified financial app simply: "One app to spend and grow your money".
...
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Service     | Features                                                  | Website             | Availability            | User Base         | Investing | Savings | Shopping (Payments) | Sustainability Focus |
+:============+:==========================================================+:====================+:========================+:==================+:==========+:========+:====================+:=====================+
| Alipay      | Payments, banking, Yu'e Bao, Ant Fortune investing        | alipay.com          | China, Global (limited) | 1.3 billion users | Yes       | Yes     | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| WeChat Pay  | Payments, financial services, Licaitong investing         | wechat.com          | China, Global (limited) | 900 million users | Yes       | No      | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Apple Pay   | Contactless payments                                      | apple.com/apple-pay | Global                  | 744 million users | No        | No      | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| PhonePe     | Payments, mutual funds, digital gold                      | phonepe.com         | India                   | 590 million users | Yes       | Yes     | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Paytm       | Payments, banking, Paytm Money for stock & fund investing | paytm.com           | India                   | 350 million users | Yes       | Yes     | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Google Pay  | Payments, loyalty, transit                                | pay.google.com      | Global                  | 150 million users | No        | No      | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Samsung Pay | Mobile payments                                           | samsung.com         | Global                  | ?                 | No        | No      | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Zelle       | Bank-to-bank P2P payments                                 | zellepay.com        | USA                     | ?                 | No        | Yes     | TRUE                | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
| Nubank      | Bank                                                      | nubank.com.br       | Brazil                  | ?                 | No        | Yes     | FALSE               | FALSE                |
+-------------+-----------------------------------------------------------+---------------------+-------------------------+-------------------+-----------+---------+---------------------+----------------------+
...
|:------|:-----------|:------|:------|:------|:------|:------|:------|:------|-------|
| Venmo | P2P payments, crypto investing | venmo.com | USA | 70 million users | Yes | No | TRUE | FALSE |  |
| Cash App | P2P payments, stock & Bitcoin investing | cash.app | USA, UK | 57 million | Yes | No | TRUE | FALSE |  |
| Chime | Online banking services including spending accounts, savings accounts | chime.com | USA | 22 million | No | Yes | TRUE | FALSE |  |
| MoneyLion | Banking, investing, credit-building loans, financial tracking tools | moneylion.com | USA | 20 million | Yes | Yes | TRUE | FALSE |  |
| NerdWallet | Financial clarity all in one place | nerdwallet.com | USA | 19 million | No | No | FALSE | FALSE |  |
| SoFi | Loans, banking, robo-investing, stock & crypto | sofi.com | USA | 10 million users | Yes | Yes | TRUE | FALSE |  |
| Albert | Budgeting, saving, spending, investing, access to financial advisors | albert.com | USA | 10 million users | Yes | Yes | FALSE | FALSE |  |
| Acorns | AI-assisted micro-investing | acorns.com | USA | 5.7 million users | Yes | No | FALSE | FALSE |  |
| Wealthsimple | AI-assisted saving & investing for Millennials | wealthsimple.com | Canada, USA, UK | 2.6 million users | Yes | Yes | FALSE | FALSE |  |
| Qapital | Saving and investing with gamification features | qapital.com | USA | 2 million users | Yes | Yes | FALSE | FALSE |  |
| M1 Finance | Finance Super App | m1.com | USA | 1 million users | Yes | No | FALSE | FALSE |  |
| Finimize | Investment research for anyone | finimize.com | Global | 1 million | Yes | No | FALSE | FALSE |  |
| Robinhood | Investing | robinhood.com | US | ? | Yes | No | FALSE | FALSE |  |
| Betterment | AI-assisted cash management, savings, retirement, and investing | betterment.com | USA | ? | Yes | Yes | FALSE | FALSE |  |
| Revolut | From payments to investing | revolut.com | UK, EU | ? | Yes | No | TRUE | FALSE |  |
| Monzo | Bank | monzo.com | UK | ? | No | Yes | FALSE | FALSE |  |
| EToro / eToro | Investing and copy-investing | etoro.com | EU | ? | Yes | No | FALSE | FALSE |  |
| Marcus Invest | Robo-Advisor | marcusinvest.com | US | ? | Yes | No | FALSE | FALSE |  |
| Varo Bank | Online banking services including checking and high-yield savings | varomoney.com | USA | ? | No | Yes | TRUE | FALSE |  |
| Stash | Micro-investing platform enabling small investments | stash.com | USA | ? | Yes | No | FALSE | FALSE |  |
| Mint | Budgeting tools, bill tracking, free credit score monitoring | mint.com | USA | ? | No | No | FALSE | FALSE | Ceased operations |

**Tier 3: Up-and-Coming Startups & Niche Players**

| Service | Features | Website | Availability | User Base | Investing | Savings | Shopping (Payments) | Sustainability Focus | Notes |
|:------|:--------|:------|:------|:------|:------|:------|:------|:------|:------|
| Chipper Cash | Digital cash app for African markets | chippercash.com | Ghana, Nigeria, Uganda, USA | ? | No | No | TRUE | FALSE |  |
| Douugh | AI financial wellness app, smart account, saving tools | douugh.com | USA, Australia | ? | Yes | Yes | TRUE | FALSE | Merged with Goodments |
| DUB | Copy-trading, mirror trades of notable figures | dubapp.com | USA | 1 million downloads | Yes | No | FALSE | FALSE |  |
| Earthfolio | AI-assisted socially responsible investing | earthfolio.com | USA | ? | Yes | No | FALSE | TRUE |  |
| Ellevest | AI-assisted robo-advisory focused on female investors and women-led business | ellevest.com | USA | ? | Yes | No | FALSE | FALSE |  |
| Goodments | Matching investment vehicles to user's environmental, social, ethical values | goodments.com | USA | ? | Yes | No | FALSE | TRUE | Merged with Douugh |
| Grünfin | Invest in funds | grunfin.com | EU | ? | Yes | Yes | FALSE | FALSE | Ceased operations |
| Lightyear | Simple UI for Stocks, ETFs, interest from Estonia | lightyear.com | EU | ? | Yes | No | FALSE | FALSE |  |
| Mintos | Buy bonds and loans | mintos.com | EU | ? | Yes | No | FALSE | FALSE |  |
| Mos | Banking for students | mos.com | US | ? | No | Yes | TRUE | FALSE |  |
| Selma | Finnish investing app | selma.com | EU | ? | Yes | No | FALSE | FALSE |  |
| Single.Earth | Nature-backed cryptocurrency | single.earth | Global | ? | Yes | No | FALSE | TRUE |  |
| Tomorrow Bank | Green Banking | tomorrow.one | EU | 120,000 | No | Yes | TRUE | TRUE |  |
| Trine | Loans to eco-projects | trine.com | USA | ? | Yes | No | FALSE | TRUE |  |
| Ziglu | UK simple investing app | ziglu.io | UK | ? | Yes | No | FALSE | FALSE |  |
...
William Northaus won a Novel Prize in 2018 for attempting to combine climate change and economics in a single, integrated assessment model, named *Dynamic Integrated Climate-Economy (DICE)*, however his predictions are considered inaccurate by climate scientists, underestimating the risk of catastrophic warming, tipping point and the probability of higher temperatures leading to mass death [@etchamWhenIdiotSavants2023; @sternEconomicsImmenseRisk2022; @sternTimeActionClimate2022; @kempClimateEndgameExploring2022; @jonesOurClimateReckless2019; @xuWellMitigationStrategies2017].

-   @nordhausClimateCasinoRisk2013
-   @instituteofinternationalandeuropeanaffairsiieaCanWorldStill2023
-   While discussion of sustainability economics is spread out over 100 different scientific journals, there's little interaction between research clusters. Elinor Ostrom vs William Nordhaus @druppOstromNordhausResearch2020 found their analysis of research published between 1987 to 2013.
...
In order to consider the sustainability on a product level, there should be a directory of all the world's products - a world product database. All of the world's products are subject to one or another standard and although they are not uniform, there's some documentation existing about every product. GS1 is the organization providing EAN/UPC barcodes on most consumer products [@gs1EANUPCBarcodes]. There are many existing specialized databases, the open product database ([@DatakickOpenProduct]), the green technology database ([@WIPOGREENGlobal]), the world packaging database ([@PackagingWorld]), just to name a few.
...
-   BeZero is innovating in the voluntary carbon credit market (VCM) by providing risk-scoring, a language financial professionals are accustomed with [@bezeroScalingCarbonMarkets2022; @tommyricketts77NavigatingNet2023]
...
-   Automate CO~2~ calculations realtime:
...
## Design Implications and Feature Ideas
...
+----------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                | Consumer          | -   *Design implication*: *As a user, I can use the app to compare banks available in my country.*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
+----------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                | Consumer          | -   **Feature:** How could people apply the same principle (**Know Your Company**) when buying a product or investing? Would building an ESG community help push polluting companies towards greener practices? - or starving them from cheap access to capital.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
+----------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
