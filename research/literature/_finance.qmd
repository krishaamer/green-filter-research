...
from charts.finance import money_chart, fintech_chart, asset_classes, shopping_growth
import warnings
...
It would be easier for large institutional investors to move their money to sustainable assets than for retail investors to move their relatively small investments.
...
Bonds are a form of debt investment. Sustainability Linked Bonds also known as green bonds.

Green bonds are released by organizations (companies, cities) to raise money for green transformation, usually for building something to improve sustainability.

-   Sustainability Linked Bonds: What this? @priscilaazevedorochaGreenwashingEnters222022: "Sustainability-linked bonds let companies borrow cheaply if they meet environmental, social, and governance targets. A Bloomberg News analysis found those goals are weak". [@priscilaazevedorochaGreenwashingEnters222022] suggests *"So far, most ESG investing is in the stock market. But the the \$22 trillion corporate bond market, where mature global companies such as Chanel go to borrow money from investors, has a particularly powerful role to play. Companies rely on debt much more than they do on stocks."*

-   world bank raise 110 million on blockchain green bond [@worldbankWorldBankPrices2018].

-   individuals can't emit a green bond but they can invest in them. it can be a way to invest locally. In 2017 the Malmö city in Sweden released green bonds to finance a sustainable transition of the city \[ bonds not emitted for financial reasons but to improve the reputation and city image , lower interest rate (aptly named *greenium*), difficult to certify, monitor report, measure impact, similar in returns to traditional bonds.

-   Hong Kong multi-currency green bond (on the blockchain?): [@hallHKBreaksNew2024]. The issuer (Hong Kong gov) hopes to reduce greenwashing [@kitanoHongKongHarnesses2024]
...
-   monitoring green bonds on EU blockchain [@christodoulouBlockchainbasedFrameworkEffective2023].

-   in china [@qinBlockchainMarketGreen2023].
...
-   In Taiwan, the *FTSE4Good TIP Taiwan ESG Index* tracks ESG-rated companies on the Taipei stock market [@taiwanindexTIPTaiWanZhiShuGongSi2024].
