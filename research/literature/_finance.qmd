...
Regenerative Finance (ReFi) leverages blockchain, DeFi, and tokenization to create financial systems that restore ecosystems and empower communities by prioritizing positive environmental and social impact over profit [@WhatReFiRegenerative2023]
...
Celo protocol invests in carbon credits on the protocol level: Celo’s protocol offsets carbon emissions at the protocol level by integrating proof-of-stake efficiency and tokenized carbon credits (e.g. Moss MCO₂) into its reserve, laying the groundwork for a regenerative financial system [@CeloRegenerativeFinance2021]. [@PlanetKlimatesLuis] Luis’s PlanetKlimate series on Moss.Earth details the issuance and tokenization of tropical-forest carbon credits (MCO₂) and biodiversity tokens within the Celo ecosystem.
...
-   @KlimaDAO2023 KlimaDAO’s 2023 protocol tokenizes real-world carbon assets into liquid Klima tokens, establishing a DAO-governed, transparent market for carbon neutrality 



-   @naturalinvestMalaikaMaphalalaNatural2020

-   @marquisRSFLeadingWay2021 In his Sept 2021 Forbes article, Christopher Marquis highlights RSF Social Finance’s pioneering shift from impact investing to regenerative finance, detailing its $230 million under management and community-pricing innovations 
