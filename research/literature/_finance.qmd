...
from charts.finance import money_chart, fintech_chart, asset_classes
import warnings
...
-   Commons, formerly known as Joro, analysis your financials to estimate your CO~2~ footprint. @chantPersonalCarboncuttingApp2022
...
Banks have access to each person's financial habits which makes it possible to model sustainable behavior using big data analysis. Taiwan's O Bank makes use of Mastercard's data to calculate each transaction's CO~2~ emissions[@TaiwanOBankLaunches2022].
...
::: {.content-hidden unless-format="pdf"}
![Bunq promises to combine banking and eco-friendly actions in the same user interface](./images/bunq.jpg){width="100%"}
:::
...
Double Eleven celebrated on November 11th (11/11) is the world's largest shopping festival [@double11festival2023]. In June 2023, 526 million people watch e-commerce livestreams in China; online bargaining is a type of ritual [@liuBargainingChineseLivestream2024].
