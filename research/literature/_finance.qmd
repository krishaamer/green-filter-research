...
![Out-of-date user interface of a European AI-Advisor ETFmatic in 2017 which was closed down in 2023 (Photo copyright ETFmatic)](./images/etfmatic.png){width="60%"}
:::
...
::: {.content-hidden unless-format="pdf"}
![Bunq promises to combine banking and eco-friendly actions in the same user interface](./images/bunq.jpg){width="60%"}
:::
...
-   Design Implication: make saving money look like an avatar or piggy bank or smth.[\
    ](https://www.sciencedirect.com/science/article/abs/pii/S0167811622000064#aep-article-footnote-id1)
