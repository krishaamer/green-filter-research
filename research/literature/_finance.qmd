...
-   [@cuppiniWhenCitiesMeet2022] historical overview of the development of capitalism from linear *Fordism* through platform economy and logistics' revolution which allows for circular economies to happen in a city. "Cuppini et al. (2022) examine how the rise and spread of digital platforms reshape cities into sites of production and circulation by altering actors and roles in urban planning and policy. They trace this process through the long-term “Logistics Revolution,” analyze how lean platform business models territorialize and generate conflicts at the urban scale, and then introduce a novel trans-urban approach—a methodological framework to study the globalized, variegated impacts of platform economy on urban space as a field of tension between multiple perspectives"
