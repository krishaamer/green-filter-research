...
Popular financial blogger [@austinryderHowBecomeInvestor2020] believes a good starting point is ask the user to define their habits: are you consumer or investor? This helps users recognize whether their spending habits define them primarily as consumers or as investors. [@smartwealthHowBecomeInvestor2021] urges readers to "consume knowledge, not products"; for financial health one should get rid of debt, automate tracking of expenses and savings, and create a pathway for income to flow into investments. Consumer mindset is the main obstacle that keeps people from financial independence and investing.
...
*Zero Waste Lifestyle* is the opposite of overconsumption. Zero waste suggests people buy in bulk to save. Buying in bulk for more savings and to reduce packaging. Through group purchases and community investing while also reducing consumption. Zero Waste municipality in Treviso is a whole region with a focus on living green. 

*Minimalism* is a movement of people living a simpler life; this probably is always going to be a small percentage of people. Yet, [@costaHowFinnishCulture2018] Finnish socialists promote minimalism as part of their policies. In Tokyo, a YouTuber shares their life and the choices they made [@tokyosimpleecolifeWhatLearnedMy2021]. Consumers choose to engage in becoming minimalist in a non-linear process with overlapping stages [@oliveirademendoncaMinimalistProcessInterpretivist2021].

[@TikTokItImportantWe] promotes the IMPACT investing app by Interactive Brokers which is a mobile trading platform focused on socially conscious investors interested in sustainability [@trahantInteractiveBrokersBuilt2022].
...
: Data compiled from [@trahantInteractiveBrokersBuilt2022; @gyuriczkiRevolutESGInvesting2025; @interactivebrokersCommissionsStockAsiaPacific2025; @lightyearFeesTaxes2025; @revolutRevolutsTradingFees2025; @revolutRevolutExplainsFractional2020; @interactivebrokersIMPACTFeatures2025]
