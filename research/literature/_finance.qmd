...
Table: Climate Experts on Company Boards []{short-caption="Climate Experts on Company Boards"}
...
Table: GenAI usage for comprehensive risk management from cyber- to climate threats in modern banking as per [@rahulagarwalHowGenerativeAI2024]. []{short-caption="GenAI In Modern Banking"}
...
Table: Comparing Investing Apps; Data compiled from [@ZigluFastSimple; @lightyearLightyearInvestingOwn; @SelmaYourFinances; @MosMoneyApp; @monzoOnlineBankingMade2023; @NubankFinalmenteVoce]. []{short-caption="Comparing Investing Apps"}
...
Table: Established consumer payment giants, none of which has a specific sustainability focus. []{short-caption="Consumer Payment Giants"}
...
Table: Growth companies in fintech, none has a sustainability focus. []{short-caption="Fast-Growing Fintech Companies"}
...
Table: Among up-and-coming startups there are some examples of sustainability-focused apps. []{short-caption="Upcoming Fintech Startups"}
...
Table: Example sustainable loyalty schemes  []{short-caption="Sustainable Loyalty Schemes"}
...
Table: Investment Types []{short-caption="Investment Types"}
...
Table: Green Investment Platforms []{short-caption="Green Investment Platforms"}
...
Table: Circular Economics in Amsterdam's Food Industry [@circleeconomyKeynoteIlektraKouloumpi2021]. []{short-caption="Circular Economics in Amsterdam's Food Industry"}
...
Table: Quantifying climate damage scenarios using integrated assessment models [@wangMultimodelAssessmentClimate2022]. []{short-caption="Integrated Assessment Models: Quantifying Climate Damage Scenarios"}
...
Energy productivity and carbon productivity are a measures of how energy intensive a product is per unit of productivity. There are people working on improving efficiency; for example [@luoControllingCommercialCooling2022] suggests using reinforcement learning to reduce energy use in cooling systems.
...
Table: Sustainability Certification Systems []{short-caption="Sustainability Certification Systems"}
...
Table: Buycotts - Active Boycotts Against Companies []{short-caption="Buycotts - Active Boycotts Against Companies"}
...
Table: Data Sharing Archetypes defined by WikiRate. []{short-caption="Data Sharing Archetypes"}
...
|------------------|------------------------|------------------------------|
| Hard to gauge quality and downside risk | Provides probabilistic ratings investors already understand | — |
| Fragmented, slow, OTC trading | — | Consolidates registries, offers 24/7 liquidity and smart-contract settlement |
| Need to move big capital fast | Gives financiers a common risk language | Cuts friction so large orders can clear quickly |

Table: Bottlenecks in Carbon Markets []{short-caption="Bottlenecks in Carbon Markets"}

Sustainability is a complex web of interconnections. To treat nature as commodity is a category mistake: it's impossible to bring back already destroyed biodiversity which took millennia to develop. Humans create hugely complex systems using technology, instead of simply conserving nature. In a sense, climate action as an asset-liability problem, however the assets are non-fungible. They are rare and incredibly valuable.