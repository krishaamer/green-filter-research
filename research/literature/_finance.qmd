...
William Northaus won a Novel Prize in 2018 for attempting to combine climate change and economics in a single, integrated assessment model, named *Dynamic Integrated Climate-Economy (DICE)*, however his predictions are considered inaccurate by climate scientists, underestimating the risk of catastrophic warming, tipping point and the probability of higher temperatures leading to mass death [@ketchamWhenIdiotSavants2023; @sternEconomicsImmenseRisk2022; @sternTimeActionClimate2022; @kempClimateEndgameExploring2022; @jonesOurClimateReckless2019; @xuWellMitigationStrategies2017].
