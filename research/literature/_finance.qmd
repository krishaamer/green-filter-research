...
: From [@circleeconomyKeynoteIlektraKouloumpi2021]. {#tbl-label}
...
: Quantifying climate damage scenarios using integrated assessment models [@wangMultimodelAssessmentClimate2022]. {#tbl-label}
...
: Data Sharing Archetypes defined by WikiRate. {#tbl-label}
