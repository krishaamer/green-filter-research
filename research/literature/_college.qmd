...
: 1.2 million UN survey responses to the statement "Climate change is an emergency". {#tbl-label}
...
: Examples of large industrial polluters in Taiwan as reported in academic papers and the media. {#tbl-label}
...
: Data from [@alanasemuelsWorldMostSustainable2024]. {#tbl-label}
...
Table: Familiarity with financial products and preferred payment methods, as reported in [@LianHeXinWenWangTaiWan2025]. []{#tbl-financial-survey short-caption="Taiwanese Financial Product Familiarity"}
...
: Financial literacy data from phone interviews, as reported in [@ZhongYangSheTaiWanJin2022]. {#tbl-label}
...
: Latest report from the 財金智慧FINLEA longitudinal study [@WangRuanGuFenYou2022]. {#tbl-label tbl-cap="FINLEA report"}
