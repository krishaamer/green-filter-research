...
-   “Evaluate and Track LLM Applications, Explainability for Neural
    Networks” (**trueraTruLens2023?**; Leino et al., 2018)

-   “evaluate your Retrieval Augmented Generation (RAG) pipelines,
    Metrics-Driven Development” (**ragasMetricsDrivenDevelopment2023?**)
...
-   LangSmith “developer platform for every step of the LLM-powered
    ...
    (**langchainDynamicFewshotExamples2024?**)
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/axis.py:1804[0m, in [0;36mAxis.convert_units[0;34m(self, x)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/category.py:57[0m, in [0;36mStrCategoryConverter.convert[0;34m(value, unit, axis)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/category.py:216[0m, in [0;36mUnitData.update[0;34m(self, data)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/_api/__init__.py:91[0m, in [0;36mcheck_isinstance[0;34m(types, **kwargs)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/collections.py:1005[0m, in [0;36m_CollectionWithSizes.draw[0;34m(self, renderer)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/collections.py:357[0m, in [0;36mCollection.draw[0;34m(self, renderer)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/collections.py:330[0m, in [0;36mCollection._prepare_points[0;34m(self)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/artist.py:291[0m, in [0;36mArtist.convert_yunits[0;34m(self, y)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/axis.py:1806[0m, in [0;36mAxis.convert_units[0;34m(self, x)[0m
...
-   GPT 4o combines different abilities into the same model, preserving
    more information: (**openaiHelloGPT4o2024?**).
...
advisor and a companion” (**prasadHowWillAlexa2022?**).
