...
Summary of 7 years of rapid AI model innovation since the first LLM in
...
| Lack of Proper Legislation | Anderljung et al. (2023) OpenAI proposes we need to proactively work on common standards and legislation to ensure AI safety. It’s difficult to come up with clear legislation; the U.K. government organized the first AI safety summit in 2023 Browne (2023).                                                                                                                                                                                                                                                                                                                                                                                 |
...
-   Schoonderwoerd et al. (2021) focuses on human-centered design of
    ...
    control over the domain? Calisto et al. (2021) discusses
    **multi-modal AI-assistant** for breast cancer classification.
...
| Data Summarizaton | AI is great at summarizing data: Peters (2023)                                                                                           |
|                   |                                                                                                                                          |
...
-   Lv et al. (2022) studies the effect of ***cuteness*** of AI apps on
    ...
    willingness to use the apps, especially for emotional tasks.
...
pioneering work aims to make computers more human-friendly.
...
MIT ELIZA project in the mid-1960s, who would dedicate time to talking
to the machine in private. The machine was called DOCTOR and emulated a
Rogerian psychotherapist, developed by Carl Rogers, from the core idea
that positive psychological functioning is a inherently human motivation
(Bassett, 2019).
...
-   The International Ergonomics Association (2019): To provide a user
    ...
    well-being”.
-   Sarah Perez (2023) character AI, AI wife Anon. (2023b); mourning
...
tombs dated 2000 years B.C. Anon. (2023c): We don’t know if these dolls
...
-   Steph Hay (2017) emotions and financial AI
...
-   Before Generative AI, financial chatbots were developed manually
    using a painstaking process that was slow and error-prone, for
    example using the Atura Process (Slack, 2021).
