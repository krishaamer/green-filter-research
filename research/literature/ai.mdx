...
<tbody>
<tr class="odd">
<td rowspan="2"><h1 id="problem">Problem</h1>
<p>Monolithicity</p></td>
<td rowspan="2"><h1 id="description">Description</h1>
<p>LLMs are massive monolithic models requiring large amounts of
...
Foundation data-sets such as LAION-5B (Romain Beaumont, 2022; Schuhmann
et al., 2022)
