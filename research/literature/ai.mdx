...
There are structures in the world, things, languages. AI with Deep
Learning is able to learn these structures and copy them into a computer
model. These representations of the real world in a digital model enable
humans to ask questions about these structures and to manipulate them to
create synthetic experiments that may match the real world. This can be
used for generating human-sounding language, finding mechanisms for
