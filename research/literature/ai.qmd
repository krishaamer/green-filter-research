...
AI has come far since Isaac Asimov proposed the 3 laws of Robotics in 1942 and Alan Turing published the Turing Test for Machine intelligence (@turingCOMPUTINGMACHINERYINTELLIGENCE1950), turning from a science-fiction concept into an everyday, mainstream reality.
...
@nobleFifthIndustrialRevolution2022 proposes we're at the beginning of the 5th industrial revolution which brings the collaboration of humans and AI.
...
AI is able to generate text, voice, images, videos, 3D objects, biological structures, etc.

-   @Singer2022MakeAVideoTG describes how collecting billions of images with descriptive data (for example the html *alt* text) has enabled researchers to train AI models such as *stable diffusion* that can generate images based on human-language AI Health
-   @HomeLarkHealth
