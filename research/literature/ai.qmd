...
Since 2020, when OpenAI released the GPT-3 large-language model (LLM), trained on 570 GB of text (@alextamkinHowLargeLanguage2021), it's become possible to make AI-generated content that's difficult to distinguish from human work (passing the Turing test). The advance of LLMs (@tamkin2021)
...
Siri, Cortana, Google Assistant, Alexa, Tencent Dingdang, Baidu Xiaodu, Alibaba AliGenie all relay on voice only.
...
There's research suggesting that voice UI accompanied by a _physical embodied system_ is preffered by users in comparison with voice-only UI (@CELINO2020102410). This suggests adding an avatar to the AI design may be worthwhile.
