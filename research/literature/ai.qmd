...
There are structures in the world: cultures, languages, human interactions all form patterns, which increasingly powerful computer systems are able to learn and copy them into a computer models. AI Approaches Deep Learning is these structures
...
-   @worldgovernmentssummitConversationFounderNVIDIA2024
...
Much is still to be understood about deep learning [@sohl-dicksteinBoundaryNeuralNetwork2024]; the fractal structure of deep learning can only be called mysterious.
...
-   OpenAI has researched a wide range of approaches towards artificial general intelligence (AGI), work which has led to advances in large language models[@ilyasutskeverIlyaSutskeverAI2018; @aifrontiersIlyaSutskeverAI2018].
...
: From reports on the advance of LLMs by [@brown2020language; @tamkin2021; @alvarezGenerateChatbotTraining2021; @hinesOpenAIFilesTrademark2023].
...
-   @huyenOpenChallengesLLM2023 provides a long list of open problems AI development; AI is still in very early stages.
...
-   @lilianwengUsingGPT4Content2023 is possible to use well-aligned AI moderate harmful content.
...
-   AI bias is well-documented and a hard problem to solve [@liangGPTDetectorsAre2023].

-   AIs outperform humans on creativity assessment tests [@mollickAutomatingCreativity2023; @haaseArtificialMusesGenerative2023]. Bots are even better than humans in solving \@ [@matthewsparkesBotsAreBetter2023].

-   @Liu_LlamaIndex_2022 LLMs have been pre-trained on massive amounts of public data, which gives them the ability for for reasoning and generating in a human-like way, yet they are missing specific private data, which needs to be ingested to augment LLMs ability to respond to questions on niche topics.
