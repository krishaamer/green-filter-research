...
Combining deep learning with reinforcement learning and reinforcement learning with human feedback (RLHF) enabled AI to achieve intelligence to beat the Turing test [@karamankeChatGPTArchitectBerkeley2022; @christianoMyResearchMethodology2021; @christianoDeepReinforcementLearning2017].

"the models are just trained to produce a single message that gets high approval from a human reader"
...
: Summary of 7 years of rapid AI model innovation since the first LLM was publicly made available in 2018 [@brown2020language; @tamkin2021; @alvarezGenerateChatbotTraining2021; @hinesOpenAIFilesTrademark2023].

Mistral Large

Metacognition -- claude 3 is the first model capable of it? ,like the zero waste workshop
...
Anthropic *resposible scaling policy* @AnthropicResponsibleScaling2023
...
| Moderating AIs          | Currently algorithms are being moderated by humans. There are studies which show how low-paid workers used to moderate harmful content; terrible for mental health (ADD CITATION). Ironically, AIs could also be part of the solution to reduce such human–abusing work. @lilianwengUsingGPT4Content2023 shows how it's possible to use well-aligned AI moderate to harmful content.                                                                                                                                                                                                                                                            |

: Some problems with contemporary AIs

## **AI’s Carbon Footprint**

-   While AI useful for carbon emission reductions AI itself has an enormous environmetal footprint [@kanungoRealEnvironmentalImpact2023]

### Human-in-The-Loop

AI responses are unreliable some percentage and require constant oversight which can come in the form of humans (human-in-the-loop) or also other AIs which are deemed to be well-aligned (termed Constitutional AI by Anthropic) [@baileyAIEducation2023; @baiConstitutionalAIHarmlessness2022].
...
Apple Watch features Fall Detection which I've experienced personally. Riding my bicycle to the NCKU library I slipped and landed on my stomach on the pavement. Watch immediately asked me: "It looks like you've taken a hard fall" and offered an option to call the ambulance. Fortunately I was OK but if I did need assistance, this AI algoright delivered contextual help which could save my health.
...
As late as in 2017, scientists were trying to create a programm with enough *natural-language understanding* to extract basic facts from scientific papers @stocktonIfAICan2017
...
| Anthropomorphic AIs                                             |
|-----------------------------------------------------------------|
| AI wife @MyWifeDead2023                                         |
| @sarahperezCharacterAIA16zbacked2023 character AI               |
| mourning 'dead' AI @phoebearslanagic-wakefieldReplikaUsersMourn |
| AI for therapy @broderickPeopleAreUsing2023                     |
| AI for bullying @sungParentsWorryTeens2023                      |
