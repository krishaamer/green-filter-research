...
: Summary: 7 years of rapid AI model innovation since the first LLM in 2018 from several reports on the advances of LLMs [@brown2020language; @tamkin2021; @alvarezGenerateChatbotTraining2021; @hinesOpenAIFilesTrademark2023].

## Responsible AI Is Needed: Generative AI's Known Issues

The are several large problems with the current generation of LLMs such as GTP3 and GPT4 by OpenAI, Microsoft, Google and Nvidia. @huyenOpenChallengesLLM2023 provides a long list of open problems AI development; AI is still in very early stages.

| Problem                    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|---------------|---------------------------------------------------------|
| Monolithcity               | LLMs are massive monolithic models requiring large amounts of computing power for training to offer ***multi-modal*** ***capabilities*** across diverse domains of knowledge, making training such models possible for very few companies. @liuPrismerVisionLanguageModel2023 proposes future AI models may instead consist of a number networked domain-specific models to increase efficiency and thus become more scalable.                                                                                                                                                                                                                  |
...
| Bias                       | AI bias is well-documented and a hard problem to solve [@liangGPTDetectorsAre2023].                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
: Problems with contemporary AIs
...
-   @anderljungFrontierAIRegulation2023 OpenAI proposes we need to proactively work on common standards and legislation to ensure AI safety.
...
The advances in the capabilities of AI large language models makes it possible to achieve ***user experience (UX) which previously was science fiction***.
...
Yet AI has becoming mainstream conversation topic as now it's calling attention to itself.
...
-   AI is great at summarizing data: @petersGoogleChromeWill2023
