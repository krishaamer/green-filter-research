...
- OpenAI provides AI-as-a-service through its APIs, allowing developer to build custom user interfaces (UI) to serve their specific customer needs 
For example Snapchat's "My AI" virtual friend help people write faster with the app helping users with predictive text completion.
