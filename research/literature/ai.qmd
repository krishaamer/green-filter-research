...
Artificial Intelligence (AI) has come far in the 80 years since Alan Turing proposed the Turing Test for Machine Intelligence. In a game setting focused on imitation, could the the AI imitate a human being so well that the person asking questions would be deceived, when simultaneously speaking to a human and a computer AI, without realizing who is the human and who is a machine? @turingCOMPUTINGMACHINERYINTELLIGENCE1950.
...
Over the 8 decades, AI development has been a long process of incremental improvements, beginning from a science-fiction concept until reaching the current stage of an everyday, mainstream reality. AI-based solutions are become a mainstay in medical research, drug development, patient care (@LEITE20212515; @holzingerAILifeTrends2023), used for quickly finding potential vaccines (@ZAFAR2022249) during the COVID19 pandemic, self-driving vehicles (passenger cars, delivery robots, drones in the sea and air, etc), and in many other industries, including AI-based assistants, which will be the focus here.
...
```
The prolific venture capital investor @AZAI defines ***"AI is computer programming that learns and adapts"***.
...
-   @rogersFourPhasesPervasive2022 defines the 4 phases of Pervasive Computing (PC).
...
-   @Singer2022MakeAVideoTG describes how collecting billions of images with descriptive data (for example the html *alt* text) has enabled researchers to train AI models such as ***stable diffusion*** that can generate images based on human-language
...
-   @microsoftMicrosoftDesignerStunning2023: Microsoft Designer allows generating UIs just based on a text prompt
-   @bedtimestory.aiAIPoweredStory2023: Personalized bed-time stories for kids generated by AI
