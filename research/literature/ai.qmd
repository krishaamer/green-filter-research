...
Microsoft provides guidelines for AI-Human interaction (@saleemaamershiGuidelinesHumanAIInteraction) which provides useful heuristics categorized by context and time 1) Initially, 2) During interaction, 3) When wrong, 4) Over time (@amershi2019guidelines).
...
@RooneyVargaClimateActionSimulation2019 shows the effictiveness of **_The Climate Action Simulation_** in educating users about success scenarios.
