...
Microsoft provides guidelines for AI-Human interaction (@saleemaamershiGuidelinesHumanAIInteraction) which provides useful heuristics categorized by context and time:
1. Initially
