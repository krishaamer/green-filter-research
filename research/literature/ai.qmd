...
-   Zhang's Personal Carbon Economy conceptualizing the idea of carbon as a currency used for buying and selling goods and services, as well as an individual carbon exchange to trade one's carbon permits (@zhangPersonalCarbonEconomy2018).
...
-   @davidjohnstonSmartAgentProtocol2023 "general purpose AI that acts according to the goals of an individual human."
...
-   @CELINO2020102410: There's research suggesting that voice UI accompanied by a *physical embodied system* is preffered by users in comparison with voice-only UI.
