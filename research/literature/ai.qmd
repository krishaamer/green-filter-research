...
-   ChatGPT passes many exams meant for humans @bubeckSparksArtificialGeneral2023
...
-   @pavlikCollaboratingChatGPTConsidering2023 and @brenta.andersWhyChatGPTSuch2022 reports on AI in education
...
### AI Interfaces and AI Explainability

AI-explainability is key to creating trust.

-   @holzingerMultimodalCausabilityGraph2021 highlights possible approaches to implementing transparency and explainability in AI models.
...
-   @khosraviExplainableArtificialIntelligence2022
-   @zerilliHowTransparencyModulates2022
-   @suArtificialIntelligenceAI2023
-   @yangArtificialIntelligenceEducation2022
-   @combiManifestoExplainabilityArtificial2022
-   @holzingerAILifeTrends2023
-   @suArtificialIntelligenceEarly2022
...
-   Personal AI Assistants to date have we created by large tech companies. Siri, Cortana, Google Assistant, Alexa, Tencent Dingdang, Baidu Xiaodu, Alibaba AliGenie all relay on voice only. There's research suggesting that voice UI accompanied by a *physical embodied system* is preffered by users in comparison with voice-only UI (@CELINO2020102410). This suggests adding an avatar to the AI design may be worthwhile.
