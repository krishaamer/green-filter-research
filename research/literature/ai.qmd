...
AI-based systems are being implemented in medical field, where stakes are high raising the need for ethical considerations.
...
In daily use of social media, we're used to interacting with the feed algorithms that provide a personalized experience. Applications with a similar UI depend on the community and content and how the content is shown to the user. After many years of user and political outcry, social media platforms have begun to shed more light on how these algorithms work, in some cases releasing the source code as is the case fro Facebook (@nickcleggHowAIInfluences2023) and Twitter (@twitterTwitterRecommendationAlgorithm2023).
