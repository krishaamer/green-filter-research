...
6.  Feedback
7.  Editing
8.  Ranking citations’ relevance to excising body of writing

AI was *NOT* used for writing.

A visualization of incremental changes to the thesis can be seen on the
GitHub repository as update commits as well as in the visualization
below.
