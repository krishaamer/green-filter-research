...
-   Mitigating Climate Change vs Adapting to Climate Change. Many companies are developing technologies for mitigation.

-   Taxes. There have been proposal of a "meat tax". Sustainable Development Goals (SDGs). Kunming-Montreal Global Biodiversity Framework. Montreal protocol near-eradication of chlorofluorocarbons (CfCs) and the ozone holes became whole again.
...
Because of the large emission fooprint of transport, offering a steep emissions reduction potential, greener modes of mobility have been heavily researched, for decades. Already more than a decade ago, a survey from April 2014 to December 2015 (n = 4586, total 29930 travel episodes), rating enjoyment on a liker scale from 1 to 7, tracked the type of travel (work, unpaid work, personal care, childcare, leisure, etc); private car 79% of personal care 55% of leisure trips; key findings show walking and cycling significantly increase enjoyment across all trip purposes; public transit reduces enjoyment for childcare and work-related travel; overall transport infrastructure can both lower green house gas emissions and boost traveler wellbeing [@echeverriaGreenMobilityWellbeing2022].
...
[@reichDefiningGoalsProduct2023] identifies *information gaps* as one of the major obstacles to realizing a circular economy; a study of 28 experts across academia, industry, government, consultancy and NGOs, showed Digital Product Passports (DPPs) can enhance the 9 "R" in circular strategies. The first full articulation of the 9 R‐strategies came from the report\
*"Circular Economy – Measuring Innovation in the Product Chain"*, where [@potting2017circular] laid out a hierarchy of circular‐economy options; the framework was later adopted and popularized in peer-reviewed literature, for example [@kirchherrConceptualizingCircularEconomy2017].
...
Even though *digital product passports* relate to circular economy, I've chosen to highlight this topic here, as it's the main design implication from this Design chapter - an emerging technology which needs to be *designed* for the user. To contextualize the discussion, a brief historical overview of previous efforts in this area may be helpful. CO~2e~ labeling initiatives represent an early attempt to communicate the environmental cost of each product. Using carbon labels to convey CO~2e~ emission of consumer products has been a topic of discussion for decades [@adamcornerWhyWeNeed2012]. Academic literature has looked at minute details such as color and positioning of the label [@zhouCarbonLabelsHorizontal2019]. There's some indication consumers are willing to pay a small premium for low-CO~2e~ products; all else being equal, consumers choose the option with a lower CO~2e~ number [@xuLowcarbonEconomyCarbon2022; @carlssonSustainableFoodCan2022]. [@cohenPotentialRoleCarbon2012] argues labeling the carbon footprint of products does help inform consumer choice towards sustainability and help promote a green economy. A large-scale study of UK university students finds some evidence to suggest labeling low CO~2e~ food enables people to choose a *climatarian diet*, however the impact of carbon labels on the market share of low-carbon meals is negligible [@lohmannCarbonFootprintLabels2022].
...
-   @jensenDigitalProductPassports2023 "support decision-making throughout product life cycles in favor of a circular economy."  "Jensen et al. study three mechatronics supply chains and identify 28 data points for DPPs, clustered into 7 categories: (1) usage & maintenance (2) identification (3) materials (4) guidelines (5) supply-chain & reverse logistics (6) environmental data (7) compliance "

-   @kingProposedUniversalDefinition2023 "influence consumer behavior towards sustainable purchasing and responsible product ownership by making apparent sustainability aspects of a product life cycle." "King et al. propose a universal definition of a Digital Product Passport Ecosystem (DPPE) as a “system-of-systems,” synthesizing stakeholder requirements and concerns from the EU’s open consultation on the Sustainable Products Initiative 
"

-   @bergerConfidentialitypreservingDataExchange2023 "support Sustainable Product Management by gathering and containing product life cycle data. However, some life cycle data are considered sensitive by stakeholders, leading to a reluctance to share such data." "Berger et al. (Proc. CIRP ‘23) outline five data-science & machine-learning approaches (e.g. model-sharing) to enable confidentiality-preserving exchange of sensitive EV-battery life-cycle data via DPPs, helping overcome stakeholder reluctance to share "

-   @plociennikDigitalLifecyclePassport2022 "Digital Lifecycle Passport (DLCP) hosted on a cloud platform and can be accessed by producers, users, recyclers"  "Plociennik et al. (Proc. CIRP ‘22) introduce a cloud-hosted Digital Lifecycle Passport (DLCP) based on the Asset Administration Shell. A SaaS web app lets producers, users and recyclers write/read DLCPs—demoing improved e-waste sorting when paired with ML-based object detection 
"

-   @bergerFactorsDigitalProduct2023 challenges with Electric Vehicle Batterys."This study provides empirical insights into the perceived potential of DPP adoption for electric-vehicle batteries within Sustainable Product Management (SPM), highlighting technical, organizational and policy barriers 

" @bergerDataRequirementsAvailabilities2023 proposes Digital Battery Passports "Berger et al. (Sci. Dir. 2023) survey EV-battery value-chain actors to map their data requirements and current availabilities, laying groundwork for a future Digital Battery Passport 
"
