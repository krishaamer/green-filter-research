...
Part of digital product design are *design systems* to keep consistency across the experience yet the latest [@DesignSystems2025] survey (n = 294) shows that over 53% of design systems are minimally automated or not automated at all - and only 10% of the designers actively use AI, with 36% having experimented with AI-driven design. These findings underline, there's still work to be done involving young HCI designers in AI-oriented workshops to show support them building the future of UI/UX [@battistoniCanAIOrientedRequirements2023].

Designers working at Google have been designing in collaboratiom with AI for a while and already in 2019 published the People + AI Guidebook, outlining best practices for designing with AI - to make human-centered AI products [@PeopleAIGuidebook].
...
[@watersEthicsChoiceAnimal2015] analyses the most effective strategies to improve animal welfare and advance animal rights against a monopolistic producer: finding negotiation, targeted direct action, and awareness campaigns condemning low-welfare practices, to be the most successful.
...
-   [@richardyangInteractionDesignMore2021; @justinbakerRedRoutesCritical2018] say some of the tools used by interaction designers include
...
More recently, [@kommendaWouldCarbonFood2022]  "interactive Carbon Food Labels experience in the Financial Times, exploring how showing carbon footprints on food packages could influence purchasing behavior; the demo shows Life Cycle Assessment (LCA) data to display products’ greenhouse gas emissions in CO₂e per kilogram, for example beef mince appears at around 27 kg CO₂e per kg, while lentils register under 1 kg CO₂e per kg, vividly illustrating the contrast in climate impact; The interactive tool allows users to stack items and instantly see cumulative emissions in their shopping cart; for instance, a typical UK supermarket basket (milk, bread, cheese, chicken, and vegetables) might total over 50 kg CO₂e for a week’s shopping;  Through real-time comparisons, the report finds that 68 percent of surveyed consumers say they’d switch to lower-impact foods if labels were straightforward, but only 22 percent trust the underlying data fully. Kommenda and colleagues argue that clear labeling could drive demand for lower-emission products, but they also highlight challenges: data standardization, verifying supply-chain emissions, and ensuring labels remain up to date as production practices evolve"
