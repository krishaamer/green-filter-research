...
[@panArtificialIntelligenceDigital2023] proposes 6 dimensions of *AI* usage in *Digital Sustainability.*
...
Circular design is only possible if supply chains become circular as well. [@oikosdenktankWebinarDoughnutEconomics2021] argues circular material procurement requires new skills.
...
- AI labs are putting a lot of effort into engineering likable AIs ,  @anthropicClaudesCharacter2024. working on honesty of the modelds, teach them to convey their own uncertainty @anthropicWhatShouldAIs2024;


which sometimes can go wrong. ChatGPT o4 overnight became your biggest fan, which users found annoying @mollickPersonalityPersuasion2025

the book, an AF (artifical friend) Klara describes loneliness @ishiguroKlaraSun2021; @waterstonesKazuoIshiguroKlara2021; @lifelessonsfrombooksKlaraSunKazuo2023




ChatGPT-4o’s abrupt shift to an overly enthusiastic persona drew user backlash.

"Kazuo Ishiguro’s Klara and the Sun offers a cautionary counterpoint, illustrating how even the most loyal and emotionally attuned AI can be perceived as uncanny or insufficiently human. These examples underscore the delicate balance required when designing AI companions for sustainability: persuasion must feel personal, but not performative.""
