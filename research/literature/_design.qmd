...
> Uncertainty of stakeholders (n = 59)
> Technological barriers (n = 45)
> Insufficient willingness to share information (n = 42)
> Lack of clear legal requirements & standards (n = 24)

Meanwhile the enablers include:

> Relative advantages (IPR concerns, reputation gains, new-market access, risk avoidance, marketing)
> Clear legal requirements
> Monetary incentives (payments for data)
> Intrinsic motivation (compatibility with values)
