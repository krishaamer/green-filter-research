...
-   Neri Oxman's expressions: "ecology-indifferent", "naturing", "mother naturing", "design is a practice of letting go of all that is unnecessary", "nature should be our single client" remind me how language shapes human thinking.
...
### Sustainability Begins in Software Design

Designing UIs for sustainable interactions means incorporating data which would enable the designers to make decisions which reduce emissions of their design. Software is key to building more sustainable products, already for decades [@guptaAnalysisArtificialIntelligencebased2023]. AI-assisted design enables design for sustainability because the design process is where sustainability begins. Companies like AutoDesk are putting CO~2~ calculations inside their design software [@mikehaleySustainabilityStartsDesign2022]. AI has the potential to provide the parameters for sustainability. [@singhArtificialNeuralNetwork2023] proposes an AI tool for deciding the suitable life cycle design parameters.
...
## Circular Design in Circular Economy 
