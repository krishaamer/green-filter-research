...
Re-designing industrial food systems for an increasing global population is a challenge.

**Fishing**

-   75% of fishing is done using industrial Trawling, which has environmental impact

-   Illegal, unreported and unregulated fishing (IIU) fishing is widespread and the EU is adopting countermeasures @kimEconomicImpactsEuropean2024
...
Many students live in dorms and shared housing, their impact per square meter is low.
...
Many circular economy service such as YouBike and transport sharing platforms like Uber are available.
