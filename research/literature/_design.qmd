...
# Superapp User Metrics (Most Recent Figures)

| **Superapp** | **Metric** | **Users (Billions)** | **Date** | **Source** |
|---------------|---------------|------------|------------|---------------|
| **Alipay (Ant Group)** | Annual Active Users (AAU) | 1.3 | 2020 | @geUpdateAlibabasAnt2020 |
| **Weixin/WeChat (Tencent)** | Monthly Active Users (MAU) – Combined Weixin & WeChat | 1,385 | 2024 | @tecentTecentHoldings20242024 |
| **Meituan** | Annual Transacting Users (ATU) | 0,77 | 2024 |  |
| **PhonePe** | Registered Users (Lifetime) | 0.5 | 2023 |  |
| **LINE** | Monthly Active Users (MAU) | 0,2 | 2023 |  |
| **Tata Neu** | NeuPass Loyalty Members | 0,027 | 2023 |  |
| **Nubank** | Customers | 0,114 | 2024 |  |
| **Zalo** | Monthly Active Users (MAU) | 0,075 | 2023 |  |
| **Paytm** | Monthly Transacting Users (MTU) | 0,1 | 2023 |  |
| **M-Pesa** | Active Customers (Kenya) | 0,034 | 2024 |  |
| **Mercado Pago** | Monthly Active Users (MAU) | 0,061 | 2023 |  |
| **PicPay** | Active Customers | 0,035 | 2023 |  |
| **Cash App (Block)** | Monthly Active Users (MAU) | 0,056 | 2023 |  |
| **KakaoTalk** | Monthly Active Users (MAU) | 0,054 | 2024 |  |
| **GoTo (Gojek/Tokopedia)** | Annual Transacting Users (ATU) | 0,05 | 2023 |  |
| **Revolut** | Customers | 0,05 | 2024 |  |
| **Careem** | Registered Customers | 0,07 | 2024 |  |
| **Grab** | Monthly Transacting Users (MTU) | 0,038 | 2024 |  |
| **Rappi** | Users (Total) | 0,03 | 2023 |  |

Each figure is sourced from official company reports, press releases, or investor disclosures. If no recent official update was available (as in the case of Alipay’s 2020 figure), the latest known official figure is provided. All values and dates reflect the latest credible data as of 2023–2024.

Each figure is sourced from official company reports, press releases, or investor disclosures. If no recent official update was available (as in the case of Alipay’s 2020 figure), the latest known official figure is provided. All values and dates reflect the latest credible data as of 2023–2024.

:   Global overview of superapps (or near-superapps) compiled from official company reports (IR, Press Releases), news reports, and company websites; various metric types (MAU, MTU, Annual Users, Customers, Registered Users) vary by company reporting and are reduced into a single "users" metric for simplicity.
...
Antpay has build the digital infrastructure to provide thousands of services to billions of users
