...
-   In March 2022, the EU Circular Economy Action Plan was adopted, looking to make sustainable products *the norm* in EU and *empowering consumers* as described in @europeancommissionCircularEconomyAction2022. Each product covered by the policy is required to have a *Digital Product Passport* (DPP) which enables improved processing within the supply chain and includes detailed information to empower consumers to understand the environmental footprint of their purchases. It's safe to say the large majority of products available today do not meet these criteria.
...
"Taleb defines “antifragility” as systems that benefit from volatility and stressors, summarizing it in a letter to Nature as “a convex response to a stressor or source of harm (for some range of variation), leading to a positive sensitivity to increase in volatility”" - "Gitcoin Passport’s Unique Humanity Score combines weighted “stamps” (e.g. verified social accounts, GTC/ETH holdings, past Grants participation). Two scoring modes—Gradual and Boolean—are used. To qualify for matching in Gitcoin Grants, users must achieve a score ≥ 15. The team is exploring “Cost of Forgery” metrics to raise the economic barrier against Sybil attacks, making fake identities progressively more expensive to create"
...
*Digital Sustainability*, information pertaining to emissions would flow through the economy not unlike the carbon cycle itself.[@panArtificialIntelligenceDigital2023] proposes 6 dimensions of *AI* usage in *Digital Sustainability*. The chart is purely illustrative to highlight the value of AI for sustainability; it's not based on numeric metrics.
...
Alipay has build the digital infrastructure to provide thousands of services to billions of users. 59 million people use Zhixiaobao, an Al financial assistant inside the Ant Fortune and Ant Insurance mini-apps inside Alipay [@finextraAntGroupsSmart2024]. Kakao Pay was found guilty of mishandling 40 million users' data by handing it over to Alipay without user consent; Alipay owns a 32 percent stake in Kakao Pay [@leeKakaoPayHanded2024].
...
*Platform Economy* marketplace companies like Airbnb, Uber, among many others match demand to offer, the process optimizing how our cities work.
...
-   Part of digital product design are *design systems* to keep consistency across the experience. Create a design system to best to showcase my analytic skills: Design System: https://zeroheight.com/8bf57183c/p/82fe98-introduction
