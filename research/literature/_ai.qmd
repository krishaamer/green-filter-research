...
-   Chatbot Research provides an Taxonomy of Social Cues for Conversational Agents, including Verbal Cue, visual, audtitory cues such as age, posture shirt, yawning and laughing: https://chatbotresearch.org/social-cue-taxonomy/

-   @WhyDesignKey2021 essential tactics for building trust in FinTech: (1) consistency in UI patterns, (2) transparent feedback, (3) clear error handling, and (4) educating users about data usage

-   @seanmcgowanUXDesignFinTech2018 offer four guidelines for fintech apps: (1) understand domain complexities, (2) friction is necessary for safety - embrace it, (3) provide continuous and clear feedback, and (4) simplify complex financial information - this can build user confidence and reduce errors.

-   @robindhanwaniFintechUIUX2021 UX problems in organiations stem for lack of alignment between teams; Design Jams for collaboration, design jams are cross-functional workshops, which can help teams align on user needs, generate rapid prototypes, and iteratively refine interfaces - a potential solution for following the guidelines above.

-   @cordeiroDesignNoLonger2016 emphasizes designing for the "unhappy path" - negative experiences shape users’ memories strongly - products which handle failures and edge cases gracefully, stand out and maintain satisfaction.