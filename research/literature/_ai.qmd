...
NVIDIA founder Jensen Huang makes the idea exceedingly clear, saying *"Everyone is a programmer. Now, you just have to say something to the computer"* [@leswingNvidiaRevealsNew2023].

[@liuMachineGazeOnline2021] suggests higher *algorithmic transparency may inhibit anthropomorphism*; people are less likely to attribute humanness to an AI companin if they understand how the system works.
...
### Conversation: the Magical Starting Point of a Relationship
...
### Usability is the Minimum of User Experience
