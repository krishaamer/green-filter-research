...
On March 13 2024, the European Parliament approved (with 523 votes for and 46 against) a comprehensive EU AI Law (also known as the Artificial Intelligence Act), taking a risk-based approach to a regulatory framework, which aims to support innovation, while safeguarding democracy and environmental sustainability [@lomasDealEUAI2024].
...
```
-   @slackAturaProcess2021 bot design process
...
-   OECD defines AI incident terms [@oecdDefiningAIIncidents2024].
...
As AI-based solutions permeate every aspect of human life, legislation is starting to catch up. The EU Artificial Intelligence Act (Regulation EU 2024/1689) establishes the first comprehensive legal framework for AI in the world, aiming to harmonize rules to ensure that AI systems are safe, human-centric, and rights-respecting; the act defines a tiered system that bans unacceptable risks and regulates high-risk uses, imposing transparency duties on developers of AI systems, for example near-realtime (hourly) CO2 emissions reports from the AI models[@EUAIAct2024].
...
: Summary of 7 years of rapid AI model innovation since the first LLM was publicly made available in 2018 [@brown2020language; @tamkin2021; @alvarezGenerateChatbotTraining2021; @hinesOpenAIFilesTrademark2023; @metaIntroducingMetaLlama2024; @baptistaDeepSeekRushesLaunch2025; @deepseek-aiDeepSeekR1IncentivizingReasoning2025].
...
-   @isabellaghassemismithInterviewDanielBaeriswyl2019 Interview Daniel Baeriswyl Magic Carpet
...
-   @davidpasztorAIUXPrinciples2018 AI UX Principles of Designing AI Products

-   @andersonWaysArtificialIntelligence2020 AI  usability

-   @lennartziburskiUXAI2018 UX of AI

-   @stephaniedonaholeHowArtificialIntelligence2021 ai Impacting UX Design

-   @lexowDesigningAIUX2021 Silicon Valley, automation, artificial systems
...
-   @akataResearchAgendaHybrid2020 "Hybrid Intelligence, Augmenting Human Intellect With Collaborative, Adaptive, Responsible, and Explainable Artificial Intelligence"

-   @dignumAIPeoplePlaces2021

-   @boleizhouCVPR22Tutorial2022 Human-Centered AI for Computer Vision.

-   @readyaiHumanAIInteractionHow2020 Human-AI Interaction

-   @vinuesaRoleArtificialIntelligence2020 ai for Sustainable Development Goals, "consensus-based expert elicitation process"

-   @orozcoBudapestBicycleNetwork2020 sustainable Urban transportation networks, sidewalks, bicycle paths, streets and rails, movement and socioeconomic life in cities, bicycle networks
...
-   @WhyDesignKey2021 building trust in FinTech

-   @seanmcgowanUXDesignFinTech2018 

-   @robindhanwaniFintechUIUX2021 Design Jams for collaboration
...
-   @outlawTurnYourCustomers2015: Regulation D 506c
