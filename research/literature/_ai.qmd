...
### Role-Play Fits Computers Into Social Contexts
...
### Anthropomorphism in AI Friends and Companions
...
### AI Support for Attitude-Behavior Gap: GenUIs
...
#### The Algorithmic Experience: Transitioning to the Complexity of Non-Deterministic Systems

For AIs to be responsible, explainable, transparent, and safe, they need certain guardrails which need to be explicitly designed.
...
AIs are fundamentally non-deterministic, which requires a new set of consideration when designing AI. AI systems may make use of several algorithms within one larger model. It follows that AI Explainability requires *Algorithmic Transparency*.

#### Designing Legislative Boundaries for AI
