...
-   Standford "thorough account of the opportunities and risks of foundation models" [@bommasaniOpportunitiesRisksFoundation2021]. "Bommasani et al. define “foundation models” as large scale pretrained models adaptable to diverse downstream tasks (for example BERT, GPT-3, CLIP). Their report surveys technical principles (model architecture, training data, evaluation), emergent capabilities across language, vision, robotics and reasoning, and societal impacts (bias, environmental cost, economic shifts, governance). They highlight the need for deep interdisciplinary research to understand how these models work and when they fail"
...
-   @xuWeSeeMachines2018 "Do We See Machines TheSame Way As We See Humans? A Survey On Mind Perception Of Machines AndHuman Beings" "	Xu and Sar conducted an online survey with 522 respondents to examine how people perceive the minds of machines versus humans along two dimensions—agency (ability to act) and experience (ability to feel). They found that humans are still attributed more mind overall, but among machines those with human-like appearance are seen as having the greatest agency and experience. Familiarity with technology correlated with attributing higher agency but lower experience to machines"
...
-   @fuLearningConversationalAI2022 Learning towards conversational AI: Survey "100-plus peer-reviewed papers (2018 – 2021)" "map the landscape for NLP researchers and highlight what still blocks “informative + controllable” conversation systems." "rule-based, retrieval-based, or generative" "models & algorithms" key results "Generative transformers dominate recent progress but still struggle with long-term coherence and factual grounding" "Retrieval-augmented hybrids show promise for informativeness, and reinforcement-learning/fine-tuning loops help steer style and safety.". "Current automatic metrics (BLEU, ROUGE, BERTScore) correlate only weakly with human judgements, so human evaluation remains indispensable."

Challenges from @fuLearningConversationalAI2022

"(1) Long-context reasoning across 10–20 turns, (2) Multi-domain adaptability without catastrophic forgetting, (3) Personalization vs. privacy, (4) Robust evaluation that captures safety, ethics, and conversational quality."
...
-   There is also the question of who bares the responsibility for the actions take by the AI agent. "Organization research suggests that acting through human agents (i.e., the problem of indirect agency) can undermine ethical forecasting such that actors believe they are acting ethically, yet (1) show less benevolence for the recipients of their power, (2) receive less blame for ethical lapses, and (3) anticipate less retribution for unethical behavior." [@gratchPowerHarmAI2022]
...
-   @nathanbenaichStateAIReport2022 State of AI Report "In its fifth edition, the State of AI Report 2022 reviews progress across research breakthroughs, commercial applications, and regulatory developments, and for the first time includes a dedicated safety section. It highlights major advances in generative models and transformer architectures, increasing AI deployment in critical infrastructure and biology, a surge in venture funding (with signs of market cooling), intensifying geopolitics in AI, and growth of the safety research community to about 300 people"
...
-   @yangArtificialIntelligenceEducation2022 proposes a curriculum for in-context teaching of AI for kids. "Yang et al. (2022) propose an “AI for Kids” curriculum for early childhood that explains why AI literacy is essential, identifies core concepts (data-driven pattern recognition, prediction, algorithmic limitations) that young children can grasp, and outlines an embodied, culturally responsive, inquiry-based pedagogy to engage learners meaningfully with AI technologies"
...
-   @yuanSocialAnxietyModerator2022: "AI assistant advantages are important factors affecting the *utilitarian/hedonic* value perceived by users, which further influence user willingness to accept AI assistants. The relationships between AI assistant advantages and utilitarian and hedonic value are affected differently by social anxiety." "Yuan, Zhang & Wang (2022) examine social anxiety as a moderator of consumers’ willingness to accept AI assistants based on utilitarian and hedonic values, showing that high anxiety heightens avoidance and shapes acceptance paths—highlighting the need for anxiety-reducing design strategies"
...
There's research of anthropomorphism or the human-like attributes of robo-advisors, such as the aforemenetioned conversational chatbots, and whether anthropomorphism can affect adoption and risk preferences among customers. Several show that anthropomorphic robo-advisors, with stronger visual human-likeness, increase customer trust and reduce algorithm aversion [@ganboldIncreasingRelianceFinancial2022; @plotkinaGiveMeHuman2024; @hildebrandConversationalRoboAdvisors2021; @deng2021anthropomorphized]. However it's not clear, if this explantion is tied to the avatar. The question - does the user trust a robot or a human, or is there a possible combination - has been researched in other literature, which does not rely on images. [@davidExplainableAIAdoption2021] looks at the whether explainable AI could help adoption of financial AI assistants in an experimental study with players (n = 210) of an online investment game had to choose between: (a) human advice, (b) AI advice without explanation, or (c) AI advice paired with an explanation; the results showed no evidence of algorithm aversion (players did not prefer human advice over AI advice).
