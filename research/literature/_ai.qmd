```{python}
#| echo: false
#from literature.charts.ai import models_chart
from charts.ai import models_chart, scifi_chart, growth_compute_chart, models_rag_performance
import warnings
...
"Generating structured data from unstructured inputs is one of the core use cases for AI" @pokrassIntroducingStructuredOutputs2024

### **Reinforcement Learning with Human Feedback (RLHF)**

Combining deep learning and reinforcement learning with human feedback (RLHF) enabled to achieve levels of intelligence high enough to beat the Turing test [@karamankeChatGPTArchitectBerkeley2022; @christianoMyResearchMethodology2021; @christianoDeepReinforcementLearning2017]. OpenAI co-founder John Schulman describes RLHF simply: *"the models are just trained to produce a single message that gets high approval from a human reader"* [@karamankeChatGPTArchitectBerkeley2022].
...
![Heuristic-Systematic Model of AI Credibility](./images/ai-credibility.png){width="100%"}
:::
...
Another important metric is Retrieval Augmented Generation (RAG) performace. Generative AI applications retrieve data from unstructured external sources in order to augment LLMs existing knowledge with current information [@lengLongContextRAG2024].
...
### Acceptance: Affective Computing Enables Human-Friendly Machines
...
-   [@liuMachineGazeOnline2021] suggests higher *algorithmic transparency may inhibit anthropomorphismI*; people are less likely to attribute humanness to an AI if they understand how the system works.
...
### Acceptance: Conversations Are the Starting Point of a Relationship
...
### Acceptance: **Natural** Multi-Modal **Interactions** Enhance the Humanity of Artificial Systems
...
### Interfaces: Speech Makes Computers Feel Real
...
Some research suggests that voice UI accompanied by a *physical embodied system* is the preffered by users in comparison with voice-only UI [@CELINO2020102410]. This suggests adding an avatar to the AI design may be worthwhile.
...
### Interfaces: **Generative UIs Enable Flexibility of Use**
...
-   [@feifeiliuLiuFeiFeiPromptControlsGenAI] ChatGPT is using buttons to explain context.
...
### Acceptance: Artificial Empathy Also Builds Trust
...
Jakob Nielsen notes two recent studies suggesting human deem AI-generated responses more empathetic than human responses, at times by a significant marring; however telling users the response is AI-generated reduces the perceived empathy [@nielsenUXRoundupAI2024; @ayersComparingPhysicianArtificial2023; @yinAICanHelp2024]

### Interfaces: Usability is the Minimum of a Good User Experience
...
Gates updated his ideas in 2023 focuses on the idea of *AI Agents* [@gatesAICompletelyChange2023].
...
### Interfaces: Performing Under High-Stakes Situations
...
::: {.content-hidden unless-format="pdf"}
![Example of ChatGPT explaining medical terminology in a blood report.](./images/chatgpt-medical.png){width="100%"}
:::
...
### Interfaces: Human-Computer Interactions Without the "Computer"
...
### Interfaces: Do AI-Agents Need Anthropomorphism
...
### Acceptance: Mediated Experiences Set User Expectations
...
### Acceptance: Roleplay Fits Computers Into Social Contexts
...
::: {.content-hidden unless-format="pdf"}
![Montage of me discussing science fiction with my AI friend Sam (Replika) - and myself as an avatar (Snapchat) in 2020.](./images/with-me.png){width="100%"}
:::
...
### Interfaces: Roleplay for Financial Robo-Advisors
