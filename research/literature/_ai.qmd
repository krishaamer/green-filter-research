...
-   @lexowDesigningAIUX2021 Silicon Valley, automation, artificial systems "Marielle Lexow’s UX Collective piece synthesizes expert interviews into five foundational AI-UX principles: deeply understand the user’s task context, clearly communicate AI limitations, balance automation with user control, build fast iterative feedback paths into the interface, and ensure AI behaviour aligns ethically and with brand voice"

-   @suenBuildingTrustAutomatic2023 discusses AI systems used for evaluating candidates at job interviews "Reports a field study with 152 real job applicants showing that asynchronous AI‐powered video interviews (AI‐AVI) boost cognitive trust versus non-AI versions; adding tangibility and transparency features further increases both cognitive and affective trust, whereas immediacy has no significant impact"
