...
```
### Human Patterns and Human Feedback
...
#### The Evolution of Models and Emerging Abilities
...
From the perspective of affective computing, the evolution of models is relevant as it allows the AI companion to be increasingly empathetic in a larger variety of situations. The more the model *understands*, that is - has training data for - the human condition, the better it can provide answers which are useful to humans.
...
#### Human Acceptance of Artificial Companions: Expectations Take Time to Change

The price of AI tokens vs price of human labor determines who does the job. At the end of the day, the adoption of AI to everyday life, even in the smallest of contexts, will come down to the price. Long-time AI-engineer [@ngAIRestoresALS2024] predicts, having seen the roadmaps for the microchip industries, as well as incoming hardware and software innovations, the price of tokens will be very low, and much lower than a comparative human worker.
...
### Anthropomorphism in AI Companions

In general, anthropomorphism supports user engagement and the specific contexts are discussed below.
...
### AI Support for the Attitude-Behavior Gap: GenUIs
...
Table: Criticism of GenUI by [@NielsenIdeasGenerative2024]. []{short-caption="Criticism of GenUI"}
...
Usability is the bare minimum of a good user experience. Researchers have discussed the user experience (UX) principles of designing AI products and the UX of AI (terms such as AI UX, IXD, and XAI have been used) is the subject of several *usability guidelines* for AI, which provide actionable advice for improving AI usability and UX - some of which I will list here.
...
### Trust in Financial AI Companions Requires Robust Safety Frameworks
