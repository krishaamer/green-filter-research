...
-   [@NielsenIdeasGenerative2024] Meanwhile is critical because for the following reasons:
...
Many researchers have discussed the user experience (UX) of AI (terms such as AIUX and XAI have been used) to provide *usability guidelines* for AI. [@combiManifestoExplainabilityArtificial2022] proposes a conceptual framework for XAI, analysis AI based on 1) Interpretability, 2) Understandability, 3) Usability, and 4) Usefulness. Many large corporations have released guidelines for Human-AI interaction as well. The AI UX team from Ericsson’s Experience Design Lab released one of the early reports, exploring the role of trust in AI services, suggesting to treat AIs an *agents* rather than tools; for the design to be successful, trust must embedded into the interface front and center, best measured on 4 categories, inspired by human relationships: 1) Competence, 2) Benevolence, 3) Integrity, and 4) Charisma [@mikaelerikssonbjorlingUXDesignAI2020]. Microsoft provides guidelines for Human-AI interaction [@li2022assessing; @amershiGuidelinesHumanAIInteraction2019] which provides useful heuristics categorized by context and time.
