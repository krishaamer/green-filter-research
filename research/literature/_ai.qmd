...
[@leeAIRevolutionMedicine2023] imagines an AI revolution in medicine using GPT models, providing improved tools for decreasing the time and money spent on administrative paperwork while providing a support system for analyzing medical data. For administrative tasks such as responding to patients' questions, medical AI has already reached - or even exceeded - expert-level question-answering ability [@singhalExpertLevelMedicalQuestion2023]. In an online text-based setting, patients rated answers from the AI better, and more empathetic, than answers from human doctors [@ayersComparingPhysicianArtificial2023]. 

Communication with the patient is perhaps the low-hanging fruit as there a numerous examples of AI-driven symptom checkers and AI-based FAQ-answering chatbots already commercially available.

-   @HealthPoweredAda health app, "Know and track your symptoms", “AI-driven health platform offering a symptom-checker app for consumers and enterprise solutions to help partners improve care through intelligent triage and data insights.

-   @BuoyHealthCheck AI symptom checker,  "Buoy Health’s AI symptom checker guides users through a brief questionnaire to generate a preliminary possible diagnosis and care recommendations, freeing up clinical resources and empowering informed patient decisions"

-   @womeninaiHowCanAI2018 AI-based health monitoring


If anything, the adoption of AI in medicine has been too cautious. [@daisywolfWhereWillAI2023] criticizes US healthcare's slow adoption of technology and predicts AI will help healthcare leapfrog into a new era of productivity by acting more like a human assistant.
...
-   @elizastricklandDrChatGPTWill2023 Chat interface for medical communication. "its common for patients to use ChatGPT to decode lab results or suggest diagnoses when doctor time is scarce. The model gives plausible answers but bundles them with the familiar disclaimer, I am not a doctor.""



-   @HomeLarkHealth track chronic condition with AI-chat "Lark Health’s digital coaching platform (formerly “Health at Home”) delivers 24/7 AI-driven support for diabetes, hypertension, weight management, and more—integrating smart scales, Fitbit rewards, and evidence-based behavior change to match live coaching outcomes at no cost with eligible insurance "
