...
Apps that started out with payments such as Revolut and N26 have
branched out into offering savings accounts and investing options.
...
(**europeanparliamentRegulationEU20232023?**;
**abnettUnitedStatesAsks2024?**)
...
-   (**EUBanForestkilling2022?**) Campain to ban polluting products
    campaign success story, EU shops can’t sell deforestation products
    gathered over 100 thousand online signatures.
...
-   Anon (n.d.s) Network for Greening the Financial System
...
-   Anon (n.d.n): Crypto investment clubs canceled

-   Anon (n.d.m): Crypto crop insurance
...
your entire supply chain.” Ratings for mines
(**carbonchainCarbonChainSummer2024?**)
...
the Tang Dynasty (618-907 AD) (Anon, n.d.j). Jeff Benson (2022) “use the
...
*Double Eleven* celebrated on November 11th (11/11) is the world’s
largest shopping festival (時代財經, 2023). In June 2023, 526 million
people watch e-commerce live-streams in China; online bargaining is a
type of ritual (Liu, House & Kádár, 2024).
...
-   Bank inside of Whatsapp for the underbanked gig workers in Latin
    America (**ycombinatorKontigoUSDCneobankLatinos2023?**)

## Investing

-   There’s literature suggesting it’s possible to make investments that
    both make an attractive financial return and adhere to
    sustainability goals. In housing development, there’s evidence of
    ‘green’ buildings achieving a ‘higher financial return than
    conventional buildings, both in terms of rent and sale price’
    (Oyedokun (2017)). There’s also a trend of investors looking for
    sustainability in addition to profits in a few countries.
...
-   Anon (n.d.q) Crypto DeFi education
...
Bonds are a form of debt investment. Sustainability Linked Bonds also
known as green bonds.

Green bonds are released by organizations (companies, cities) to raise
money for green transformation, usually for building something to
improve sustainability.

-   Sustainability Linked Bonds: What this? Priscila Azevedo Rocha,
    Akshat Rathi & Todd Gillespie (2022): “Sustainability-linked bonds
    let companies borrow cheaply if they meet environmental, social, and
    governance targets. A Bloomberg News analysis found those goals are
    weak”. (Priscila Azevedo Rocha, Akshat Rathi & Todd Gillespie, 2022)
...
-   individuals can’t emit a green bond but they can invest in them. it
    ...
    \[ bonds not emitted for financial reasons but to improve the
    reputation and city image , lower interest rate (aptly named
    *greenium*), difficult to certify, monitor report, measure impact,
    similar in returns to traditional bonds.

-   Hong Kong multi-currency green bond (on the blockchain?):
    (**hallHKBreaksNew2024?**). The issuer (Hong Kong gov) hopes to
    reduce greenwashing (**kitanoHongKongHarnesses2024?**)
...
-   monitoring green bonds on EU blockchain
    (**christodoulouBlockchainbasedFrameworkEffective2023?**).

-   in china (**qinBlockchainMarketGreen2023?**).

-   overview of 23 low-carbon blockchains
    (**alzoubiGreenBlockchainMove2023?**)
...
benchmarks in EU.” (**europeancommissionEULabelsBenchmarks2019?**).
...
-   The Conservation Alliance:
    (**climateneutralcertifiedClimateNeutralStandards2023?**).
...
-   Google Environmental Insights Explorer enables local governments
    (cities) to measure CO2 emissions and enact environmental policies
    that optimize city functions such as traffic flows (Anon, n.d.r;
...
-   Singapore ESG open data platform
...
-   Anon (n.d.af) Largest consumer goods companies
...
-   Anon (n.d.i) BCorporation listings by country
-   Anon (2017)
-   Citywealth (2021)
-   Anon (n.d.z)
-   RavenPack (2021)
...
-   Anon (n.d.u): Open Knowledge Foundation’s Open Product Data website
    shut down
...
-   World product database
    ...
    -   Anon (n.d.ag) green tech database

    -   Anon (n.d.v) packaging database
...
finding the right sustainable strategy” (Margaryta Kirakosian & Angus
Foote, 2022)\].
...
-   “But the real breakthrough is how we can surface that real-time ESG
    ...
    (**ratkovicLeadingWayRealTime2023?**)
...
-   Anon (n.d.f): Governance or Corporate Responsibility
...
-   Anon (n.d.y): Sites like Simply Wallstreet provide in-depth
