...
to 105 Trillion USD in 2023 (Aaron O’Neill, 2023;
**IMFWorldEconomicOutlook2023?**). In essence, the estimated total
investment gap in climate fits into the economic growth of 1 year of the
global economy.
...
-   Anon (2023k) “The quality of growth matters”. John Fullerton (2011):
...
-   Anon (n.d.r): Sites like Simply Wallstreet provide in-depth
...
-   Ethical Shopping
-   Anon (n.d.x) Largest consumer goods companies
...
-   Anon (n.d.o): Open Knowledge Foundation’s Open Product Data website
    shut down
...
-   World product database
    ...
    -   Anon (n.d.y) green tech database

    -   Anon (n.d.p) packaging database
