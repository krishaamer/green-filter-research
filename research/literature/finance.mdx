...
> Environmental Law & Policy, 2018) and (Anon, n.d.y:p.33).
...
even decoupling from environmental degradation is a topic hotly (pun
intended) debated among scientists.

(Keyßer & Lenzen, 2021) provides several scenarios for low, medium, and
high levels of decoupling titled Degrowth, IPCC, and Dec-Extreme.
...
-   Anon (n.d.m) app for nutrition and sustainability data
...
-   World product database
    ...
    -   Anon (n.d.x) green tech database
...
-   Ethical Shopping
-   Anon (n.d.w) Largest consumer goods companies
