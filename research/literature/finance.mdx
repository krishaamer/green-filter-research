...
adoption. The goal of these laws, first adopted in the European Union, a
...
![](finance_files/figure-markdown_strict/cell-15-output-2.png)

![](finance_files/figure-markdown_strict/cell-15-output-3.png)
