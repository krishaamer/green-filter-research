...
(European Parliament, 2023; Abnett & Abnett, 2024)
...
-   (Anon, 2022c) Campain to ban polluting products campaign success
    story, EU shops can’t sell deforestation products gathered over 100
    thousand online signatures.
...
-   One example is Revolut, which expanded from a simple payments app to
    support varied saving and investment types \[Anon (2023m);
    @KickstartYourInvestment2023\].
...
European customer in summer 2024 (**revolutRevolutUnlocksBonds2024?**;
**revolutOur2023Annual2024?**). Investing in bonds is a form of *Passive
Investing* and allows investors focus on low-risk passive income instead
of daily stock investing most popular on Robinhood and Revolut - albeit
with much less potential for returns.
...
currently Europe is the largest emitter of green bonds
(**climatebondsClimateBondsInteractive2023?**). China has the 2nd
largest green bond market in the world and it’s growing fast; buyers are
...
‘regular’ bond (Peng & Xiong, 2022; Li, Zhang & Wang, 2022).
...
report and measure impact of
(**sjostromFinancingSustainableCity2020?**).
...
SDG-related projects (**worldbankWorldBankPartners2024?**;
**worldbankWorldBankIssues2019?**; World Bank, 2018).
...
-   Anon (2023k) calculate climate cost
...
-   Anon (2023p) Personalised portfolios
...
to edge funds, a DAO can have a shared multi-sign wallet than is
invested together.
...
-   Anon (2023l) “The quality of growth matters”. John Fullerton (2011):
...
-   The Conservation Alliance: (Climate Neutral Certified, 2023).
...
-   Anon (2023n) For example, the Green Web Foundation certifies how
...
2017), while Nasdaq Nordic introduced an ESG index in 2018, and
