...
*Fintechs* (digital financial technologies) enable new modes of
...
-   Legislation sets higher standards. (Anon, n.d.i) Ban polluting
...
-   HM Treasury (2020) Taxonomy of sustainable activities in the UK
-   Anon (2023s)
-   Quinson (2020) While the larger trend is for governments to adapt to
    and work towards their environmental climate commitments and public
    demand, the sovereign risk remains an issue. For example, the
    policies supported by U.S. President Trump during his presidency ran
    counter to many sustainability recommendations, including those
...
-   Anon (n.d.d): digital assets bank

-   Anon (n.d.ae): Crypto bank
...
-   Anon (n.d.b) estimates over 600 million cryptocurrency users
    worldwide
...
-   Anon (n.d.o): Crypto investment clubs canceled

-   Anon (n.d.n): Crypto crop insurance
...
(GIMF) (**laxtonGlobalIntegratedMonetary2010?**) and DSGE (Dynamic
...
-   Whie Adam Smith is most famous for his concept of the invisible
    hand, his writings also highlight the interdependence of economic
    actors \[(**atalAdamSmithHis2024?**)\]
...
Card” products (Anon, 2022d). Mastercard has developed a service that
...
the Tang Dynasty (618-907 AD) (Anon, n.d.k). Jeff Benson (2022) “use the
...
-   Anon (n.d.r) Crypto DeFi education
...
Green bonds are released by organizations (companies, cities) to raise
money for green transformation, usually for building something.

-   Sustainability Linked Bonds: What this?

-   world bank raise 110 million on blockchain green bond
...
-   individuals can’t emit a green bond but they can invest in them. it
    can be a way to invest locally. In 2017 the Malmö city in Sweden
    ...
    bonds not emitted for finacial reasons but to improve the reputation
    and city image , lower interest rate (greenium), difficult to
    certify, monitor report, measure impact, similar in returns to
    traditiional bonds.

-   Hong Kong multi-currency green bond (on the blockchain?):
...
-   monitoring green bonds on EU blockchain
    [https://www.sciencedirect.com/science/article/abs/pii/S1544612323007699](https://www.sciencedirect.com/science/article/abs/pii/S1544612323007699)

-   in china
    [https://www.sciencedirect.com/science/article/abs/pii/S0140988322006302](https://www.sciencedirect.com/science/article/abs/pii/S0140988322006302)

-   [https://www.sciencedirect.com/science/article/pii/S0959652623036995](https://www.sciencedirect.com/science/article/pii/S0959652623036995)
...
-   Anon (n.d.g) Responsible business index
...
-   Google Environmental Insights Explorer enables local governments
    ...
    that optimize city functions such as traffic flows (Anon, n.d.s;
...
-   Anon (n.d.ag) Largest consumer goods companies
...
-   Anon (n.d.j) BCorporation listings by country
-   Anon (2017)
-   Citywealth (2021)
-   Anon (n.d.aa)
-   RavenPack (2021)
...
-   Anon (n.d.v): Open Knowledge Foundation’s Open Product Data website
    shut down
...
-   World product database
    -   Anon (n.d.c): “open product database”

    -   Anon (n.d.ah) green tech database

    -   Anon (n.d.w) packaging database
...
-   Anon (n.d.f): “But the real breakthrough is how we can surface that
...
-   Anon (n.d.z): Sites like Simply Wallstreet provide in-depth
