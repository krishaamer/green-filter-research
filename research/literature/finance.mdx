...
> Environmental Law & Policy, 2018) and (Anon, n.d.x:p.33).
...
-   Anon (n.d.l) Crypto DeFi education
...
(n.d.t): Crypto bank - Raido Tõnisson (2022a) Estonian bank selling
...
-   Anon (n.d.j): Crypto investment clubs canceled

-   Anon (n.d.i): Crypto crop insurance
...
-   Anon (n.d.n): Open Knowledge Foundation’s Open Product Data website
    shut down
...
-   World product database
    ...
    -   Anon (n.d.w) green tech database

    -   Anon (n.d.o) packaging database
...
WikiRate is a tool for checking green credentials Transparency; they
define Data Sharing Archetypes (WikiRate, 2021).
...
-   Ethical Shopping
-   Anon (n.d.v) Largest consumer goods companies
...
-   Anon (n.d.q): Sites like Simply Wallstreet provide in-depth
...
optimize city functions such as traffic flows (Anon, n.d.m; Nicole
Lombardo, 2021)
...
alliance (**climateaction100+Companies2023?**; Sommer, Demirtaş &
Muirhead, 2024).

(**climateaction100+Companies2023?**) tracks large emitters around the
world with combined market cap of \$10.3 Trillion USD.

![](finance_files/figure-markdown_strict/cell-26-output-1.png)

Majority of large emitters companies don’t have climate experts
(**climateaction100+Companies2023?**).
...
Anon (n.d.h) *Home - ChainReact*.
[https://chainreact.org/](https://chainreact.org/).

Anon (n.d.i) *IBISA Network – Enabling the Next Generation of Insurance
for Agriculture*. [https://ibisa.network/](https://ibisa.network/).

Anon (n.d.j) *Investment Clubs and Collectives Deprecation FAQ*.
...
Anon (n.d.k) *Investment Products Investor.gov*.
...
Anon (n.d.l) Lets Do DeFi - DeFi Guides Grandma Can Follow 👵🏻. *Lets Do
...
Anon (n.d.m) *Methodology - Google Environmental Insights Explorer -
...
Anon (n.d.n) Open Product Data. *Open Product Data*.
[https://product.okfn.org/](https://product.okfn.org/).

Anon (n.d.o) Packaging World. *Packaging World*.
[https://www.packworld.com/](https://www.packworld.com/).

Anon (n.d.p) Planet of the Klimates - Luis Adaime - Founder & CEO of
MOSS.Earth. *RSS.com*.
...
Anon (n.d.q) *Simply Wall St - Stock & Sector Analysis Made Simple*.
[https://simplywall.st/](https://simplywall.st/).

Anon (n.d.r) Social Enterprises, B Corps, Benefit Companies, ESG. *Green
...
Anon (n.d.s) Socially Responsible Investing Advisors. *Natural
Investments*.
...
Anon (n.d.t) *The Bank for the New Economy*.
...
Anon (n.d.v) Top 100 Consumer Goods Companies of 2021. *Consumer Goods
Technology*.
...
Anon (n.d.w) *WIPO GREEN: The Global Marketplace for Sustainable
Technology*.
...
Anon (n.d.x) *Yale, Princeton, Stanford, MIT and Vanderbilt students
