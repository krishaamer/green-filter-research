...
*Fintech* - financial technologies - linked to *ESG* (Environmental,
Social, and Corporate Governance) may hold the potential to drive
consumers on a pathway towards sustainable investing. Does this funnel
work - and it’s indeed a complex multi–step funnel -, depends on whether
we can deliver a simple user experience and curb greenwashing to a level
that allows consumer to distinguish eco–friendly businesses from the
heavy polluters.

This chapter explores the larger trend of *Democratization of Financial
Markets* through consumer-facing apps that enable new interactions which
increasingly blur boundaries between shopping, saving, and investing.
Efforts to boost user numbers have made apps that started out with
payments-only - such as Revolut and N26 - branch out into offering
savings accounts and investing options. Regardless of if it’s money
spent on shopping or saved and invested, these are all decision of
capital allocation, and in one way or another, we’re giving our money to
companies. The critical question is: do we choose to support
sustainability-focused companies or those that pay less attention to
sustainability?

Users are beginning to become money-savvy yet are still missing many key
ideas from financial literacy. Giving users exposure to investment
opportunities through familiar activities that may have the potential to
boost financial literacy levels and entice consumers to learn more about
taking advantage of their opportunities financial markets - as well as
...
new types of money is also created by companies and individuals using
cryptography on blockchain-based distributed databases, which keep track
...
1930’s US Great Depression \[kentonWhatLayawayPlan2023\].

-   Gen-Z mostly used BNPL to buy clothes.
-   44.1% of Gen-Z in the US had used BNPL in 2022 (EMarketer, 2021).
-   ***Design Implication:*** This suggests users are already used to
    having more options in the payment flow.
-   However The Influencer Factory (2021) suggest Chinese and U.S.
    markets may be mature and growth will come from emerging markets
    (SEA, Latin-America); China is the furthest ahead in social
    shopping.
...
-   In housing development, there’s evidence of ‘green’ buildings
    achieving a ‘higher financial return than conventional buildings,
    both in terms of rent and sale price’ (Oyedokun, 2017).
...
-   One example is Revolut, which expanded from a simple payments app to
    support varied saving and investment types (Anon, 2023n, 2023h).
...
European customer in summer 2024 (Revolut, 2024b, 2024a). Investing in
...
literacy than traditional financial assets. Anon (n.d.b) estimates over
...
-   Raido Tõnisson (2022b) due to a law change Estonian could take out
    their pensions and invest or spend them however they wanted. Raido
    Tõnisson (2022a) Estonian bank selling Metaverse cryptocurrency
    Sandbox
...
The possibility of decoupling economic growth from CO2 emissions
(sometimes called eco-economic decoupling or decarbonizing economies) or
even decoupling from environmental degradation - is a topic debated
among scientists.
...
-   In the United Kingdom, (harrisson, 2019) concludes UK’s CO2e
    emissions have fallen 43% from 1990 to 2017 through the use of less
    carbon-intensive energy sources and argues for moderate policies in
    (Hausfather & Peters, 2020). Meanwhile, contrarily, (Global Carbon
    Budget, 2023)’s data shows an increasing CO2e emissions trend in the
    UK in the same timeframe.
...
Vietnam and Somalia (Viana Espinosa De Oliveira & Moutinho, 2022;
...
Prices Do Not Capture All Costs “CONSUMPTION, PRODUCTION, AND INVESTMENT
decisions of individuals, households, and firms often affect people not
directly involved in the transactions.” Helbling (n.d.)
...
-   Determinants of high esg performance are board member diversity,
    firm size, ceo attributes Martiny et al. (2024).
...
-   (Yüksel, Kalyoncu & Özdurak, 2023) criticizes excessive
    financialization for the 2008 economic crisis where the real economy
    and financial markets disconnected, proposing a new index for
    *participation finance* aiming to ground the financial economy in
    the real economy; rooted in Islamic banking, participation finance
    avoids highly speculative activities, which are seen as
    exploitative, looking to promote stability, transparency, and
    fairness.

Companies assess customer’s credit score to decide credit-worthiness,
however how can customers rate companies? Indexes make comparing
companies possible. There are many-many Indexes, Scoring Systems,
...
-   The As Your Sow NGO aims to champion CSR through building coalitions
    ...
    Funds initiative which researches and rates funds’ exposure to
    fossil fuels finance and its sister project Invest in Your Values
    rates retirement plans offered by employers (mostly US technology
...
Research shows certification does matter. Consumers are willing to pay
more for bio-based products “72% of Europeans are willing to pay more
for environmentally friendly products. The study identifies a”green
premium” and a “certified green premium,” indicating increased WTP for
bio-based and certified bio-based products.” Morone et al. (2021) (need
access).

-   In Italy, consumer awareness of sustainable supply chains, Italian
    consumers have a strong preference for antibiotic-free meat
...
-   Science-Based Targets initiative (SBTi) provides step-by–step
    guidance per economic sector help companies get started with meeting
    climate criteria and emission reduction requirements.
