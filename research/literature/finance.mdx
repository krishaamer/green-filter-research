...
![](finance_files/figure-markdown_strict/cell-6-output-2.png)

![](finance_files/figure-markdown_strict/cell-6-output-3.png)

![](finance_files/figure-markdown_strict/cell-6-output-4.png)
...
the Tang Dynasty (618-907 AD) (Anon, n.d.f). Jeff Benson (2022) “use the
...
> Environmental Law & Policy, 2018) and (Anon, n.d.v:p.33).
...
-   One example is Revolut, which expanded from a simple payments app to
    support varied saving and investment types (Anon, 2023j, 2023g).
...
also deems “\[t\]he quality of growth matters” (Anon, 2023i). For
...
(**etchamWhenIdiotSavants2023?**; Stern, Stiglitz & Taylor, 2022; Stern,
2022; Kemp et al., 2022; Jones & Steffen, 2019; Xu & Ramanathan, 2017).
...
-   Trucost, a company launched in 2000 to calculate the hidden
    ...
    03, 2016, 08:30 ET; Anon, 2019). It’s parent company S&P Global also
    acquired RobecoSAM’s ESG rating business, consolidating S&P’s
...
alliance (Climate Action 100+, 2023; Sommer, Demirtaş & Muirhead, 2024).
...
less carbon than those with lower scores.”* (Amenc, Goltz & Naly, 2023).

The lack of rigor is creating a backlash against ESG reporting.(Yu,
2021) reports ESG is filled with greenwashing. Anon (2023a) several US
...
“sustainable funds don’t buy Zomato’s ESG narrative”. Bindman, Mendonca
& Mendonca (2024) reports large ESG funds managed by BlackRock and
Vanguard are investing into JBS, a meat-packing company which is linked
to deforestation of the Amazon rainforest through it’s supply chain.
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/IPython/core/pylabtools.py:187[0m, in [0;36mretina_figure[0;34m(fig, base64, **kwargs)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/cartopy/mpl/geoaxes.py:524[0m, in [0;36mGeoAxes.draw[0;34m(self, renderer, **kwargs)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/matplotlib/axes/_base.py:3137[0m, in [0;36m_AxesBase.draw[0;34m(self, renderer)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/cartopy/mpl/feature_artist.py:185[0m, in [0;36mFeatureArtist.draw[0;34m(self, renderer)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/cartopy/feature/__init__.py:309[0m, in [0;36mNaturalEarthFeature.intersecting_geometries[0;34m(self, extent)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/cartopy/feature/__init__.py:112[0m, in [0;36mFeature.intersecting_geometries[0;34m(self, extent)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/cartopy/feature/__init__.py:294[0m, in [0;36mNaturalEarthFeature.geometries[0;34m(self)[0m
[1;32m    290[0m [38;5;28;01mif[39;00m key [38;5;129;01mnot[39;00m [38;5;129;01min[39;00m _NATURAL_EARTH_GEOM_CACHE:
[1;32m    291[0m     path [38;5;241m=[39m shapereader[38;5;241m.[39mnatural_earth(resolution[38;5;241m=[39m[38;5;28mself[39m[38;5;241m.[39mscale,
[1;32m    292[0m                                      category[38;5;241m=[39m[38;5;28mself[39m[38;5;241m.[39mcategory,
[1;32m    293[0m                                      name[38;5;241m=[39m[38;5;28mself[39m[38;5;241m.[39mname)
[0;32m--> 294[0m     geometries [38;5;241m=[39m [38;5;28;43mtuple[39;49m[43m([49m[43mshapereader[49m[38;5;241;43m.[39;49m[43mReader[49m[43m([49m[43mpath[49m[43m)[49m[38;5;241;43m.[39;49m[43mgeometries[49m[43m([49m[43m)[49m[43m)[49m
[1;32m    295[0m     _NATURAL_EARTH_GEOM_CACHE[key] [38;5;241m=[39m geometries
[1;32m    296[0m [38;5;28;01melse[39;00m:

File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/cartopy/io/shapereader.py:167[0m, in [0;36mBasicReader.geometries[0;34m(self)[0m
[1;32m    164[0m [38;5;28;01mfor[39;00m shape [38;5;129;01min[39;00m [38;5;28mself[39m[38;5;241m.[39m_reader[38;5;241m.[39miterShapes(bbox[38;5;241m=[39m[38;5;28mself[39m[38;5;241m.[39m_bbox):
[1;32m    165[0m     [38;5;66;03m# Skip the shape that can not be represented as geometry.[39;00m
[1;32m    166[0m     [38;5;28;01mif[39;00m shape[38;5;241m.[39mshapeType [38;5;241m!=[39m shapefile[38;5;241m.[39mNULL:
[0;32m--> 167[0m         [38;5;28;01myield[39;00m [43msgeom[49m[38;5;241;43m.[39;49m[43mshape[49m[43m([49m[43mshape[49m[43m)[49m

File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/shapely/geometry/geo.py:105[0m, in [0;36mshape[0;34m(context)[0m
[1;32m    103[0m     [38;5;28;01mreturn[39;00m MultiPoint(ob[[38;5;124m"[39m[38;5;124mcoordinates[39m[38;5;124m"[39m])
[1;32m    104[0m [38;5;28;01melif[39;00m geom_type [38;5;241m==[39m [38;5;124m"[39m[38;5;124mmultilinestring[39m[38;5;124m"[39m:
[0;32m--> 105[0m     [38;5;28;01mreturn[39;00m [43mMultiLineString[49m[43m([49m[43mob[49m[43m[[49m[38;5;124;43m"[39;49m[38;5;124;43mcoordinates[39;49m[38;5;124;43m"[39;49m[43m][49m[43m)[49m
[1;32m    106[0m [38;5;28;01melif[39;00m geom_type [38;5;241m==[39m [38;5;124m"[39m[38;5;124mmultipolygon[39m[38;5;124m"[39m:
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/shapely/geometry/multilinestring.py:60[0m, in [0;36mMultiLineString.__new__[0;34m(self, lines)[0m
[1;32m     57[0m [38;5;28;01mif[39;00m [38;5;28mlen[39m(lines) [38;5;241m==[39m [38;5;241m0[39m:
[1;32m     58[0m     [38;5;28;01mreturn[39;00m shapely[38;5;241m.[39mfrom_wkt([38;5;124m"[39m[38;5;124mMULTILINESTRING EMPTY[39m[38;5;124m"[39m)
[0;32m---> 60[0m [38;5;28;01mreturn[39;00m [43mshapely[49m[38;5;241;43m.[39;49m[43mmultilinestrings[49m[43m([49m[43msubs[49m[43m)[49m

File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/shapely/decorators.py:77[0m, in [0;36mmultithreading_enabled.<locals>.wrapped[0;34m(*args, **kwargs)[0m
...
File [0;32m~/Desktop/current/thesis/green-filter-research/myenv/lib/python3.10/site-packages/shapely/creation.py:393[0m, in [0;36mmultilinestrings[0;34m(geometries, indices, out, **kwargs)[0m
[1;32m    390[0m     geometries [38;5;241m=[39m linestrings(geometries)
[1;32m    392[0m [38;5;28;01mif[39;00m indices [38;5;129;01mis[39;00m [38;5;28;01mNone[39;00m:
[0;32m--> 393[0m     [38;5;28;01mreturn[39;00m [43mlib[49m[38;5;241;43m.[39;49m[43mcreate_collection[49m[43m([49m[43mgeometries[49m[43m,[49m[43m [49m[43mtyp[49m[43m,[49m[43m [49m[43mout[49m[38;5;241;43m=[39;49m[43mout[49m[43m,[49m[43m [49m[38;5;241;43m*[39;49m[38;5;241;43m*[39;49m[43mkwargs[49m[43m)[49m
[1;32m    394[0m [38;5;28;01melse[39;00m:
[1;32m    395[0m     [38;5;28;01mreturn[39;00m collections_1d(geometries, indices, typ, out[38;5;241m=[39mout)

[0;31mTypeError[0m: ufunc 'create_collection' not supported for the input types, and the inputs could not be safely coerced to any supported types according to the casting rule ''safe''
```
...
Anon (n.d.c) *ESG Analytics <span class="nocase">Real-time ESG
Scores</span> and Ratings for Companies Globally GHG Emission data*.
[https://esganalytics.io/](https://esganalytics.io/).

Anon (2021c) *ESG hedge funds Barclays Corporate & Investment Bank*.
...
Anon (2021d) Meet the fintechs leading Sweden’s green revolution.
*Sifted*.
...
Anon (2023i) Regenerative capitalism: A new era of economics. *The RSA*.
...
Anon (2023j) Revolut launches ETF trading platform in Europe. *ETF
Stream*.
...
Anon (2019) S&P rolls out Trucost ESG data to its customers.
...
Anon (n.d.t) Top 100 Consumer Goods Companies of 2021. *Consumer Goods
Technology*.
...
Anon (2023k) Trees for the Future. *Trees for the Future*.
[https://trees.org/](https://trees.org/).

Anon (2023l) What is ReFi Regenerative Finance explained. *Toucan
Protocol*.
[https://blog.toucan.earth/what-is-refi-regenerative-finance/](https://blog.toucan.earth/what-is-refi-regenerative-finance/).

Anon (n.d.u) *WIPO GREEN: The Global Marketplace for Sustainable
Technology*.
...
Anon (n.d.v) *Yale, Princeton, Stanford, MIT and Vanderbilt students
...
Climate Action 100+ (2023) Companies. *Climate Action 100+*.
...
doi:[10.1016/j.ecolecon.2020.106620](https://doi.org/10.1016/j.ecolecon.2020.106620).
...
before the crash – it’s time to talk about near-term collapse. *The
Conversation*.
...
e2108146119.
doi:[10.1073/pnas.2108146119](https://doi.org/10.1073/pnas.2108146119).
...
Ketcham, C. (2023) When Idiot Savants Do Climate Economics. *The
Intercept*.
...
Laureen van Breen, Aileen Robinson, Abigail Munroe & Adriana Bora (2023)
Panel: Scaling Corporate Accountability: Humans and AI together in the
fight to \#EndSlavery. *Scottish AI Summit*.
...
BlackRock’s BUIDL shares. *CryptoSlate*.
...
DiFranzo (eds.). *Internet Science*. Cham, Springer International
Publishing. pp. 74–88.
doi:[10.1007/978-3-319-45982-0_7](https://doi.org/10.1007/978-3-319-45982-0_7).
...
fuel divestment. *Current Opinion in Environmental Sustainability*. 66,
101394.
doi:[10.1016/j.cosust.2023.101394](https://doi.org/10.1016/j.cosust.2023.101394).
...
213–248.
doi:[10.1016/j.iotcps.2023.05.003](https://doi.org/10.1016/j.iotcps.2023.05.003).
...
doi:[10.1093/ej/ueac005](https://doi.org/10.1093/ej/ueac005).
...
181–216.
doi:[10.1080/1350178X.2022.2040740](https://doi.org/10.1080/1350178X.2022.2040740).
...
uncovering living wage gaps in fashion supply…. *Medium*.
...
10315–10323.
doi:[10.1073/pnas.1618481114](https://doi.org/10.1073/pnas.1618481114).
