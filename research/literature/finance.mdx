...
[`
<table>
<caption>Comparative Data on Investing Apps; compiled from <span class="citation" data-cites="trahantInteractiveBrokersBuilt2022 gyuriczkiRevolutESGInvesting2025 interactivebrokersCommissionsStockAsiaPacific2025 lightyearFeesTaxes2025 revolutRevolutsTradingFees2025 revolutRevolutExplainsFractional2020 interactivebrokersIMPACTFeatures2025">[@trahantInteractiveBrokersBuilt2022; @gyuriczkiRevolutESGInvesting2025; @interactivebrokersCommissionsStockAsiaPacific2025; @lightyearFeesTaxes2025; @revolutRevolutsTradingFees2025; @revolutRevolutExplainsFractional2020; @interactivebrokersIMPACTFeatures2025]</span></caption>
<colgroup>
<col style="width: 25%" />
<col style="width: 25%" />
<col style="width: 25%" />
...
<caption>Climate Experts on Company Boards</caption>
<colgroup>
<col style="width: 16%" />
<col style="width: 16%" />
<col style="width: 16%" />
...
`,`
<table>
<caption>Comparing Payments Apps; Data compiled from <span class="citation" data-cites="focustaiwanIPASSLaunchesQR2025 taiwannewsPXPay1stTaiwan2025 pxpayplusPXPayJPMorgan">[@focustaiwanIPASSLaunchesQR2025; @taiwannewsPXPay1stTaiwan2025; @pxpayplusPXPayJPMorgan]</span></caption>
<colgroup>
<col style="width: 21%" />
<col style="width: 34%" />
<col style="width: 21%" />
...
`,`
<table>
<caption>Investment Types</caption>
<thead>
<tr>
...
`,`
<table>
<caption>Green Investment Platforms</caption>
<colgroup>
<col style="width: 25%" />
<col style="width: 25%" />
<col style="width: 25%" />
...
`,`
<table>
<caption>Circular Economics in Amsterdam’s Food Industry <span class="citation" data-cites="circleeconomyKeynoteIlektraKouloumpi2021">[@circleeconomyKeynoteIlektraKouloumpi2021]</span>.</caption>
<thead>
<tr>
...
`,`
<table>
<caption>Sustainability Certification Systems</caption>
<colgroup>
<col style="width: 25%" />
<col style="width: 25%" />
<col style="width: 50%" />
...
`,`
<table>
<caption>Buycotts - Active Boycotts Against Companies</caption>
<colgroup>
<col style="width: 25%" />
<col style="width: 25%" />
<col style="width: 25%" />
...
`,`
<table>
<caption>Data Sharing Archetypes defined by WikiRate.</caption>
<colgroup>
<col style="width: 38%" />
<col style="width: 61%" />
</colgroup>
...
`,`
<table>
<caption>Bottlenecks in Carbon Markets</caption>
<colgroup>
<col style="width: 26%" />
<col style="width: 33%" />
<col style="width: 40%" />
...
<div id="fig-fintech-growth">

![](finance_files/figure-markdown_strict/fig-fintech-growth-output-1.png)
...
<div id="fig-retail-green-nongreen">

![](finance_files/figure-markdown_strict/fig-retail-green-nongreen-output-1.png)
...
disclosures (**francesschwartzkopffFirmsArenReporting2022?**).
...
Schwartzkopff, 2022) suggests the ESMA and EU has strengthened
...
<div id="fig-conv-vs-sri">

![](finance_files/figure-markdown_strict/fig-conv-vs-sri-output-1.png)
...
broken or simply misunderstood. (**pietrocecereItTotalMess2023?**) calls
ESG labeling confusing and arbitrary; fund selectors describe ESG
labeling as “a total mess,” pointing to confusing definitions,
inconsistent methodologies, and overlapping ratings that undermine
clarity. (“Financial Materiality Marks Next Big ESG Investing Battle,”
...
practiced worldwide (UK Parliament, 2024). (**maiImpactUKModern2023?**)
finds the quality of the reporting remains low among FTSE 100 (index of
highly capitalized listings on the London Stock Exchange) companies. Not
...
<div id="fig-slavery-laws">

![](finance_files/figure-markdown_strict/fig-slavery-laws-output-1.png)
...
<div id="fig-air-quality-sea">

![](finance_files/figure-markdown_strict/fig-air-quality-sea-output-1.png)
...
<div id="fig-esg-leaders">

![](finance_files/figure-markdown_strict/fig-esg-leaders-output-1.png)
...
became a part of its ESG product offering (Mike Hower, Dec 9, 2015 7am
EST; Toffel & Sice, 2011; **indicesDowJonesIndices2016?**;
**RollsOutTrucost2019?**). It’s parent company S&P Global also acquired
RobecoSAM’s ESG rating business, consolidating S&P’s control of ESG
ratings (**georgegeddesGlobalAcquiresRobecoSAM2019?**).

<div id="fig-triple-perf">

![](finance_files/figure-markdown_strict/fig-triple-perf-output-1.png)
...
<div id="fig-esg-rating-agencies">

![](finance_files/figure-markdown_strict/fig-esg-rating-agencies-output-1.png)

Figure 8: ESG Rating Agencies

</div>
<div id="fig-fund-types">

![](finance_files/figure-markdown_strict/fig-fund-types-output-1.png)
...
major governance gap (Climate Action 100+, 2023;
**sommerWhoClimateExpert2024?**).

<div dangerouslySetInnerHTML={{ __html: quartoRawHtml[1] }} />

<div id="fig-board-sust-expert">

![](finance_files/figure-markdown_strict/fig-board-sust-expert-output-1.png)

Figure 10: Lack of Board Members With Sustainability Expertise

</div>
<div id="fig-board-sust-expert-large">

![](finance_files/figure-markdown_strict/fig-board-sust-expert-large-output-1.png)
...
<div id="fig-companies-carbon-criteria">

![](finance_files/figure-markdown_strict/fig-companies-carbon-criteria-output-1.png)
...
<div id="fig-board-diversity">

![](finance_files/figure-markdown_strict/fig-board-diversity-output-1.png)
...
climate-focused funding. (**korosecAmazonTaps2B2021?**) reports that
...
will reduce material waste. “Good intentions don’t work, mechanisms do,”
Amazon’s founder Bezos is quoted as saying in (Clifford, 2022). Walmart
is taking a similar approach, having launched a project in 2017 to set
...
its sister project *Invest in Your Values* rates retirement plans
...
<div id="fig-esg-board-div-comp">

<div id="fig-esg-board-div-comp-1">

![](finance_files/figure-markdown_strict/fig-esg-board-div-comp-output-1.png)

(a) Simplified comparison chart for board diversity (gender and
cultural) vs ESG score

</div>

<div id="fig-esg-board-div-comp-2">

![](finance_files/figure-markdown_strict/fig-esg-board-div-comp-output-2.png)

(b)

</div>

<div id="fig-esg-board-div-comp-3">

![](finance_files/figure-markdown_strict/fig-esg-board-div-comp-output-3.png)
...
sufficient ESG data for comparison, building an *Fintech Adoption
...
<div id="fig-esg-fintech-pred">

![](finance_files/figure-markdown_strict/fig-esg-fintech-pred-output-1.png)
...
months, which they call *“Product Lifecycle Intelligence”*
(**kylewiggersMakersiteLands18M2022?**). More recently, Makersite has
updated the language they use for promoting their product, now calling
it *Product Sustainability Modeling* (Makersite, n.d.). Apart from
product level analytics, there’s sustainability data on source raw
materials. CarbonChain rolled out asset-level emissions ratings for
individual mines: covering metals including steel, aluminium, nickel,
and copper - so product developers can benchmark material sources’
carbon intensity against industry averages (CarbonChain, n.d.).
...
<div id="fig-sust-consum">

<div id="fig-sust-consum-1">

![](finance_files/figure-markdown_strict/fig-sust-consum-output-1.png)

(a) Sustainable Consumption

</div>

<div id="fig-sust-consum-2">

![](finance_files/figure-markdown_strict/fig-sust-consum-output-2.png)

(b)

</div>

<div id="fig-sust-consum-3">

![](finance_files/figure-markdown_strict/fig-sust-consum-output-3.png)

(c)

</div>

<div id="fig-sust-consum-4">

![](finance_files/figure-markdown_strict/fig-sust-consum-output-4.png)
...
<div id="fig-shopping-growth">

![](finance_files/figure-markdown_strict/fig-shopping-growth-output-1.png)
...
![](finance_files/figure-markdown_strict/fig-soc-com-output-1.png)
...
Card”* products (**TaiwanOBankLaunches2022?**). This is based on
...
<div id="fig-climate-fin-funding">

![](finance_files/figure-markdown_strict/fig-climate-fin-funding-output-1.png)
...
<div id="fig-climate-fin-funding-sectors">

![](finance_files/figure-markdown_strict/fig-climate-fin-funding-sectors-output-1.png)
...
<div id="fig-high-value-assets">

![](finance_files/figure-markdown_strict/fig-high-value-assets-output-1.png)
...
Group’s CEO Eric Jing remarked in (**turrinCashlessChinaDigital2021?**):
*“The financial system of the past 200 years was designed for the
...
(**doornStocksThatShould2020?**). Among retail investors, there’s some
appetite for sustainability however investors are not sure how to
separate sustainable assets from less sustainable ones (Ho, 2019). While
literature has been debating if it’s possible to *“do well while doing
good”*, latest research suggests it’s possible to make investments that
both make an attractive financial return and adhere to sustainability
goals (Y.-M. Tan et al., 2023). *“sustainable investing is now part of
mainstream financial strategy”* (Morgan Stanley, 2019).

(**smithChinaUltraElite2019?**) suggests 74% of Chinese youth are
looking for “positive impact” and (Lingeswaran, 2019) philanthropy is on
the rise in Asia in general. (Li et al., 2022) believes retail investors
are important for innovation: *“investor attention can significantly
...
<div id="fig-asset-classes">

![](finance_files/figure-markdown_strict/fig-asset-classes-output-1.png)
...
similar to the price of a ‘regular’ bond (W. Peng & Xiong, 2022;
**liWhereGreenBond2022?**). The Climate Bonds Initiative, which is
working on greening the entire short-term debt (bond) market, puts the
size of the entire market at \$55 trillion, underlining the relative
percentage of green bonds is tiny (“Climate Bonds Initiative Calls for
...
<div id="fig-world-bank-bonds">

![](finance_files/figure-markdown_strict/fig-world-bank-bonds-output-1.png)
...
found those goals are weak”.
(**priscilaazevedorochaGreenwashingEnters222022?**) suggests *“So far,
...
risks against the rewards”* (**hesterm.peirceSECGovStatement2022?**).
...
<div id="fig-bitcoin-vs-gold">

![](finance_files/figure-markdown_strict/fig-bitcoin-vs-gold-output-1.png)
...
<div id="fig-crypto-price-theory">

![](finance_files/figure-markdown_strict/fig-crypto-price-theory-output-1.png)
...
technology to carbon accounting, market development, and governance
...
(**ianbezekItTimeEveryone2021?**) argues that DAOs and governance tokens
...
introduction. Finally, (“Empowering Digital Asset Banking,” n.d.) notes
it’s not only retail investor entering the crypto world, large
institutions are doing the same, with tokenisation, crypto custody and
...
(Chainlink, 2022; **bradydaleChainlinkFounderSays2021?**).
...
(**vanzantenWhoOwnsSustainable2023?**). In institutional finance, the
Norwegian \$1.3T USD sovereign wealth fund (the world’s largest) started
a divestment trend in 2016 by divesting first from coal following by
divesting from oil, gas and coal extracting companies
(**benmartinWorldLargestWealth2017?**;
**holgerNorwaySovereignWealthFund2019?**). Their plan to reach net zero
CO<sub>2</sub>eq nonetheless only targets 2050. Furthermore, who would
be the counterpart for such large transactions. The fund also announced
divesting from Russia after its invasion of Ukraine, however has yet to
sell any shares citing lack of buyers on the Moscow stock market. Even
with divesting from oil and has, Norway Government Pension Fund Global
(GPFG) still adheres to the Markowitz’s Modern Portfolio Theory (MPT),
with enough diversification between assets (Papaioannou & Rentsendorj,
2015).
...
<div id="fig-econ-history">

![](finance_files/figure-markdown_strict/fig-econ-history-output-1.png)
...
argues in (**guptaElectrifyingEconomistGuide2020?**) we should include
...
expand the role of the government (**horwitzThereHoleMiddle2017?**),
doughnut practitioners in Brussels believe everything can be adapted to
the place and context (BrusselsDonut, 2022; Oikos Denktank, 2021).
...
decoupling) or is hotly debated (pun intended) among scientists.
(**keysserDegrowthScenariosSuggest2021?**) provides several scenarios
for low, medium, and high levels of decoupling titled Degrowth, IPCC,
and Dec-Extreme.

<div id="fig-clim-scen">

![](finance_files/figure-markdown_strict/fig-clim-scen-output-1.png)

Figure 27: Climate Scenarios

</div>

Looking a the United Kingdom, (**harrissonAnalysisWhyUK2019?**)
concludes UK’s CO<sub>2e</sub> emissions have fallen 43% from 1990 to
2017 through the use of less carbon-intensive energy sources and argues
for moderate policies in (Hausfather & Peters, 2020).

<div id="fig-uk-emissions-trends">

![](finance_files/figure-markdown_strict/fig-uk-emissions-trends-output-1.png)
...
the same time-frame show the historic responsibility of UK
(**globalcarbonbudgetCumulativeCOEmissions2023?**).
...
<div id="fig-brics-emissions-trends">

![](finance_files/figure-markdown_strict/fig-brics-emissions-trends-output-1.png)
...
source materials (**InnocentOpens200m?**). Palsgaard, a large producer
...
Stern, 2022; **xuWellMitigationStrategies2017?**).
...
the rise of e-commerce marketplaces (**semantics3WhyUPCDoesn2017?**). As
early as 2016, (Håkon Bogen, 2016) raised questions whether a global
database of all EAN (European Article Number) barcoded products could be
created. Barcodes help identify products within supply chains and retail
systems, but they do not alone create a central product registry. On a
basic level, standardized product codes ensures product inventory,
...
<div id="fig-csrd_timeline">

![](finance_files/figure-markdown_strict/fig-csrd_timeline-output-1.png)
...
<div id="fig-energy-prod">

![](finance_files/figure-markdown_strict/fig-energy-prod-output-1.png)
...
<div id="fig-cabon-prod">

![](finance_files/figure-markdown_strict/fig-cabon-prod-output-1.png)
...
world” (WikiRate, 2023; **millsWikiRateOrgLeveraging2016?**).
Transparency is about culture but also mechanisms and tools, which is
why WikiRate defines Data Sharing Archetypes (WikiRate, 2021).
...
Frances Schwartzkopff. (2022). EU Explores Tighter Rules for ESG Funds
