...
College students in particular are concerned with the environment, yet they are also busy with school and hindered by unavailability of simple tools to make sustainable financial action convenient. Stronger environmental policy from the European Union includes the concept of ***digital product passports***, which hold the promise to help distinguish ***eco-designed*** products made by ***circular economy*** companies truly trying to be zero-waste from companies that simply say they are. Tracking product data from the source materials until the consumer, combined with ***data-driven interaction design*** enables us to build transparency into opaque systems. Likewise, advances in the development of ***large-language models*** enable ***artificial intelligence assistants*** to become a translation layer between complex environmental data and human-comprehensible language, improving our ability to affect systemic change.

My research addresses the need for tools that help college students take environmentally sustainable financial actions. I focus on leveraging ***design research*** to find design concepts for ***simpler*** ***AI user interfaces*** to help college students participate in ***sustainable financial activism***. A survey of 700 students across 10 universities in Taiwan was conducted, enhanced by 5 expert interviews providing industry insights. The major contribution of the study is an interactive AI-assistant prototype.
