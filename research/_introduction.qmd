...
![College Students' Concept Map](./images/introduction/abstract.png){#fig-college-students-concepts width="100%" fig-lof-cap="College Students' Concept Map"}
:::
...
::: {.content-hidden unless-format="pdf"}
![Star Trek’s Captain Sulu using a tricorder (futuristic device example) - Photo copyright by Paramount Pictures](./images/introduction/tricorder.jpg){#fig-co2-tricorder width="50%" fig-lof-cap="Star Trek’s Captain Sulu using a tricorder (futuristic device example)"}
:::
