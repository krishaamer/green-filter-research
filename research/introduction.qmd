...
| Question | Methods |
|----------------------------------------|--------------------------------|
| How could an AI companion make use of existing knowledge in sustainability, design, and finance to support college students? | Literature Review |
| How could an AI companion help college students reward sustainable companies when shopping, saving, and investing? | Literature Review and Expert Interviews |
| What particular AI companion features do college students prioritize? | Survey of College Students |
