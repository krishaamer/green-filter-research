...
Due to the large amounts of data captured by the initial survey (over 1600 people started the survey; after filtering, over 800 Gen-Z current college students finished it fully), I've chosen to exclude it from the PDF version of my thesis. The data is available upon request - and has also been published on Hugging Face as a public dataset: https://huggingface.co/datasets/krishaamer/taiwanese-college-students
