...
[@baytas3KindsDesign2020] categorizes design research into three modes: (1) conducting research to inform design decisions, (2)studying designs to generate knowledge, and (3) using design itself as a means of inquiry. My research is of the first category, aiming make better design design decisions for my sustainability-focused financial app.

I started with literature review, which led into expert interviews (because of the many questions arising from the literature). I identified key concepts from expert discussions and gained exposure to their industry insights.
...
When developing my research design, I relied on the advice of [@christianrohrerWhenUseWhich2022] to decide when to choose which User-Experience Research methods. 
...
```
### 1st Wave of (Preliminary) Testing (Spring 2024)
...
### 2nd Wave of (In Production) Testing (Autumn 2024 - Spring 2025)
...
Talked to 5 experts over video call and 1 one expert face-to-face; all interviews were in English. I recorded audio and video, transcribed the conversations, and then perform thematic analysis of the contents.