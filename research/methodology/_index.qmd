...
import AppTestingFlow2 from '../images/testing/app-testing-flow-2.svg'
...
::: {.content-hidden unless-format="pdf"}
![Google Chrome Extension User Interaction Flow](./images/testing/app-testing-flow-2.svg){width="100%"}
:::
