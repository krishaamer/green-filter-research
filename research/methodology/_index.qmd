...
Table: Theoretical Lenses Found in My Research.
...
![Initial Concept Map](./images/methodology/concept-map.png){width="100%"}
:::

```{=mdx}
<Figure caption="Initial Concept Map" src={Concepts} />
```
Conceptual Model
