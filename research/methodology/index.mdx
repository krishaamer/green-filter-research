...
questions from literature review). Identify key concepts from expert
discussion and gain industry insights.
...
Similarly to (Liu et al., 2023) I distributed the survey in schools in
...
from the data analysis. References were stored in the Zotero paid
version with 6 GB storage. Bibtex and Better Bibtex were used to export
the references to the .bib format consumable by Quarto.
...
decisions for a sustainability-focused financial app.
...
Talk to 5 experts over video call and 1 one face-to-face in English;
record, transcribe, and perform thematic analysis of the contents.
