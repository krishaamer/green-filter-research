...
design experts; located everywhere.
...
interviews recorded online and offline. Talked to 5 experts over video
call and 1 one expert face-to-face; all interviews were in English. I
recorded audio and video, transcribed the conversations, and then
perform thematic analysis of the contents.
...
previously identified factors, and prepared a survey, including a Likert
scale, and a choice experiment, focusing on the preferences of the
potential users in generation-z aged 18-29, living in Taiwan, exploring
the relationship between independent variables: - “Interest in
Sustainability” - “Interest in Investing” - “Preferred Features” - and
the dependent variable “User Sign-ups”.
...
that may still emerge.Choice Experiment: The survey includes a choice
...
In the third stage, I return to the qualitative methods, by building a
prototype of the sustainable investing AI companion, taking into account
insights gathered in the previous stage. I will used face-to-face
interview to discuss the prototype, and conducted a thematic analysis of
the discussions’ recordings, leading to further validation of previously
...
Thematic Analysis Finally, I will perform a thematic analysis of the
focus group transcriptions in order to validate previous findings, and
