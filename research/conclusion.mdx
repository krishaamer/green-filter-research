...
My prototype *“Green Filter”* app introduced here is an AI companion
that translates raw environmental and financial data into plain
language, revealing facts like the ESG record and CO₂eq emission of a
product, the materials used, the factory where it came from, etc. It
aims to nudge users toward greener shopping, treating purchases as a
...
report (e.g. “Your spending this month saved X kg CO<sub>2</sub>” or
“you’re now 20% greener”). This aligns with providing “carbon score”
feedback that testers noticed. The dashboard should be succinct, using
visuals (progress bars, infographics) rather than verbose text, so
students quickly grasp progress (Huang’s scale idea).
